...
#include "webkit/WebKitDOMLocationPrivate.h"
...
WebKitDOMLocation* kit(WebCore::Location* obj)
{
    ...
    if (gpointer ret = DOMObjectCache::get(obj))
        return static_cast<WebKitDOMLocation*>(ret);

    return static_cast<WebKitDOMLocation*>(DOMObjectCache::put(obj, WebKit::wrapLocation(obj)));
}
...
WebCore::Location* core(WebKitDOMLocation* request)
{
    ...
    WebCore::Location* coreObject = static_cast<WebCore::Location*>(WEBKIT_DOM_OBJECT(request)->coreObject);
...
WebKitDOMLocation* wrapLocation(WebCore::Location* coreObject)
{
    ...
    return  WEBKIT_DOM_LOCATION(g_object_new(WEBKIT_TYPE_DOM_LOCATION,
...
static void webkit_dom_location_finalize(GObject* object)
{
    ...
    if (dom_object->coreObject) {
        WebCore::Location* coreObject = static_cast<WebCore::Location *>(dom_object->coreObject);
...
static void webkit_dom_location_set_property(GObject* object, guint prop_id, const GValue* value, GParamSpec* pspec)
{
...
static void webkit_dom_location_get_property(GObject* object, guint prop_id, GValue* value, GParamSpec* pspec)
{
    WebCore::JSMainThreadNullState state;
...
static void webkit_dom_location_constructed(GObject* object)
{

    if (G_OBJECT_CLASS(webkit_dom_location_parent_class)->constructed)
        G_OBJECT_CLASS(webkit_dom_location_parent_class)->constructed(object);
}
...
static void webkit_dom_location_class_init(WebKitDOMLocationClass* requestClass)
{
    ...
    gobjectClass->set_property = webkit_dom_location_set_property;
    gobjectClass->get_property = webkit_dom_location_get_property;
    gobjectClass->constructed = webkit_dom_location_constructed;
