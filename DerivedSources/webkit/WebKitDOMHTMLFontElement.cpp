...
WebKitDOMHTMLFontElement* kit(WebCore::HTMLFontElement* obj)
{
    ...
    if (gpointer ret = DOMObjectCache::get(obj))
        return static_cast<WebKitDOMHTMLFontElement*>(ret);

    return static_cast<WebKitDOMHTMLFontElement*>(DOMObjectCache::put(obj, WebKit::wrapHTMLFontElement(obj)));
}
...
WebCore::HTMLFontElement* core(WebKitDOMHTMLFontElement* request)
{
    ...
    WebCore::HTMLFontElement* coreObject = static_cast<WebCore::HTMLFontElement*>(WEBKIT_DOM_OBJECT(request)->coreObject);
...
WebKitDOMHTMLFontElement* wrapHTMLFontElement(WebCore::HTMLFontElement* coreObject)
{
    ...
    return  WEBKIT_DOM_HTML_FONT_ELEMENT(g_object_new(WEBKIT_TYPE_DOM_HTML_FONT_ELEMENT,
...
static void webkit_dom_html_font_element_finalize(GObject* object)
{

    WebKitDOMObject* dom_object = WEBKIT_DOM_OBJECT(object);
    
    if (dom_object->coreObject) {
        WebCore::HTMLFontElement* coreObject = static_cast<WebCore::HTMLFontElement *>(dom_object->coreObject);
    ...
    G_OBJECT_CLASS(webkit_dom_html_font_element_parent_class)->finalize(object);
}

static void webkit_dom_html_font_element_set_property(GObject* object, guint prop_id, const GValue* value, GParamSpec* pspec)
{
...
static void webkit_dom_html_font_element_get_property(GObject* object, guint prop_id, GValue* value, GParamSpec* pspec)
{
    WebCore::JSMainThreadNullState state;
    WebKitDOMHTMLFontElement* self = WEBKIT_DOM_HTML_FONT_ELEMENT(object);
    WebCore::HTMLFontElement* coreSelf = WebKit::core(self);
...
static void webkit_dom_html_font_element_constructed(GObject* object)
{

    if (G_OBJECT_CLASS(webkit_dom_html_font_element_parent_class)->constructed)
        G_OBJECT_CLASS(webkit_dom_html_font_element_parent_class)->constructed(object);
}

static void webkit_dom_html_font_element_class_init(WebKitDOMHTMLFontElementClass* requestClass)
{
    GObjectClass *gobjectClass = G_OBJECT_CLASS(requestClass);
    gobjectClass->finalize = webkit_dom_html_font_element_finalize;
    ...
    gobjectClass->constructed = webkit_dom_html_font_element_constructed;
