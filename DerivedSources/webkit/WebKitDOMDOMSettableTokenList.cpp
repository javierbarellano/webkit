...
WebKitDOMDOMSettableTokenList* kit(WebCore::DOMSettableTokenList* obj)
{
    ...
    if (gpointer ret = DOMObjectCache::get(obj))
        return static_cast<WebKitDOMDOMSettableTokenList*>(ret);

    return static_cast<WebKitDOMDOMSettableTokenList*>(DOMObjectCache::put(obj, WebKit::wrapDOMSettableTokenList(obj)));
}
...
WebCore::DOMSettableTokenList* core(WebKitDOMDOMSettableTokenList* request)
{
    ...
    WebCore::DOMSettableTokenList* coreObject = static_cast<WebCore::DOMSettableTokenList*>(WEBKIT_DOM_OBJECT(request)->coreObject);
...
WebKitDOMDOMSettableTokenList* wrapDOMSettableTokenList(WebCore::DOMSettableTokenList* coreObject)
{
    ...
    return  WEBKIT_DOM_DOM_SETTABLE_TOKEN_LIST(g_object_new(WEBKIT_TYPE_DOM_DOM_SETTABLE_TOKEN_LIST,
...
static void webkit_dom_dom_settable_token_list_finalize(GObject* object)
{

    WebKitDOMObject* dom_object = WEBKIT_DOM_OBJECT(object);
    
    if (dom_object->coreObject) {
        WebCore::DOMSettableTokenList* coreObject = static_cast<WebCore::DOMSettableTokenList *>(dom_object->coreObject);
    ...
    G_OBJECT_CLASS(webkit_dom_dom_settable_token_list_parent_class)->finalize(object);
}

static void webkit_dom_dom_settable_token_list_set_property(GObject* object, guint prop_id, const GValue* value, GParamSpec* pspec)
{
...
static void webkit_dom_dom_settable_token_list_get_property(GObject* object, guint prop_id, GValue* value, GParamSpec* pspec)
{
    WebCore::JSMainThreadNullState state;
    WebKitDOMDOMSettableTokenList* self = WEBKIT_DOM_DOM_SETTABLE_TOKEN_LIST(object);
    WebCore::DOMSettableTokenList* coreSelf = WebKit::core(self);
...
static void webkit_dom_dom_settable_token_list_constructed(GObject* object)
{

    if (G_OBJECT_CLASS(webkit_dom_dom_settable_token_list_parent_class)->constructed)
        G_OBJECT_CLASS(webkit_dom_dom_settable_token_list_parent_class)->constructed(object);
}

static void webkit_dom_dom_settable_token_list_class_init(WebKitDOMDOMSettableTokenListClass* requestClass)
{
    GObjectClass *gobjectClass = G_OBJECT_CLASS(requestClass);
    gobjectClass->finalize = webkit_dom_dom_settable_token_list_finalize;
    ...
    gobjectClass->constructed = webkit_dom_dom_settable_token_list_constructed;
