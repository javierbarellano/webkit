...
WebKitDOMNodeIterator* kit(WebCore::NodeIterator* obj)
{
    ...
    if (gpointer ret = DOMObjectCache::get(obj))
        return static_cast<WebKitDOMNodeIterator*>(ret);

    return static_cast<WebKitDOMNodeIterator*>(DOMObjectCache::put(obj, WebKit::wrapNodeIterator(obj)));
}
...
WebCore::NodeIterator* core(WebKitDOMNodeIterator* request)
{
    ...
    WebCore::NodeIterator* coreObject = static_cast<WebCore::NodeIterator*>(WEBKIT_DOM_OBJECT(request)->coreObject);
...
WebKitDOMNodeIterator* wrapNodeIterator(WebCore::NodeIterator* coreObject)
{
    ...
    return  WEBKIT_DOM_NODE_ITERATOR(g_object_new(WEBKIT_TYPE_DOM_NODE_ITERATOR,
...
static void webkit_dom_node_iterator_finalize(GObject* object)
{
    ...
    if (dom_object->coreObject) {
        WebCore::NodeIterator* coreObject = static_cast<WebCore::NodeIterator *>(dom_object->coreObject);
...
static void webkit_dom_node_iterator_set_property(GObject* object, guint prop_id, const GValue* value, GParamSpec* pspec)
{
...
static void webkit_dom_node_iterator_get_property(GObject* object, guint prop_id, GValue* value, GParamSpec* pspec)
{
    WebCore::JSMainThreadNullState state;
...
static void webkit_dom_node_iterator_constructed(GObject* object)
{

    if (G_OBJECT_CLASS(webkit_dom_node_iterator_parent_class)->constructed)
        G_OBJECT_CLASS(webkit_dom_node_iterator_parent_class)->constructed(object);
}
...
static void webkit_dom_node_iterator_class_init(WebKitDOMNodeIteratorClass* requestClass)
{
    ...
    gobjectClass->set_property = webkit_dom_node_iterator_set_property;
    gobjectClass->get_property = webkit_dom_node_iterator_get_property;
    gobjectClass->constructed = webkit_dom_node_iterator_constructed;
...
webkit_dom_node_iterator_next_node(WebKitDOMNodeIterator* self, GError **error)
{
    ...
    PassRefPtr<WebCore::Node> g_res = WTF::getPtr(item->nextNode(ec));
    if (ec) {
...
webkit_dom_node_iterator_previous_node(WebKitDOMNodeIterator* self, GError **error)
{
    ...
    WebCore::NodeIterator * item = WebKit::core(self);
    WebCore::ExceptionCode ec = 0;
    PassRefPtr<WebCore::Node> g_res = WTF::getPtr(item->previousNode(ec));
    if (ec) {
        WebCore::ExceptionCodeDescription ecdesc(ec);
        g_set_error_literal(error, g_quark_from_string("WEBKIT_DOM"), ecdesc.code, ecdesc.name);
    }
...
webkit_dom_node_iterator_get_reference_node(WebKitDOMNodeIterator* self)
{
    ...
    WebCore::JSMainThreadNullState state;
    WebCore::NodeIterator * item = WebKit::core(self);
    PassRefPtr<WebCore::Node> g_res = WTF::getPtr(item->referenceNode());
    WebKitDOMNode* res = WebKit::kit(g_res.get());
    return res;
}
...
webkit_dom_node_iterator_get_pointer_before_reference_node(WebKitDOMNodeIterator* self)
{
    ...
    WebCore::JSMainThreadNullState state;
    WebCore::NodeIterator * item = WebKit::core(self);
    gboolean res = item->pointerBeforeReferenceNode();
    return res;
}
