...
private:
    static bool canGetItemsForName(JSC::ExecState*, HTMLPropertiesCollection*, const JSC::Identifier&);
...
JSC::JSValue jsHTMLPropertiesCollectionLength(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsHTMLPropertiesCollectionNames(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsHTMLPropertiesCollectionConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
