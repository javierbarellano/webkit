...
#endif
JSC::JSValue jsHTMLMediaElementMediaGroup(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSHTMLMediaElementMediaGroup(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsHTMLMediaElementController(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
