...
bool JSHTMLHeadElementConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSHTMLHeadElementConstructor, JSDOMWrapper>(exec, &JSHTMLHeadElementConstructorTable, static_cast<JSHTMLHeadElementConstructor*>(cell), propertyName, slot);
}

bool JSHTMLHeadElementConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSHTMLHeadElementConstructor, JSDOMWrapper>(exec, &JSHTMLHeadElementConstructorTable, static_cast<JSHTMLHeadElementConstructor*>(object), propertyName, descriptor);
}
...
bool JSHTMLHeadElement::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSHTMLHeadElement::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
JSValue jsHTMLHeadElementProfile(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    JSValue result = jsString(exec, impl->getAttribute(WebCore::HTMLNames::profileAttr));
    return result;
}
...
void JSHTMLHeadElement::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
    JSHTMLHeadElement* thisObject = jsCast<JSHTMLHeadElement*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
