...
JSC::JSValue jsMutationRecordType(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsMutationRecordTarget(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsMutationRecordAddedNodes(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsMutationRecordRemovedNodes(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsMutationRecordPreviousSibling(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsMutationRecordNextSibling(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsMutationRecordAttributeName(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsMutationRecordAttributeNamespace(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsMutationRecordOldValue(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsMutationRecordConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
