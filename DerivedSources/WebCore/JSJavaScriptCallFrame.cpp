...
bool JSJavaScriptCallFramePrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSJavaScriptCallFramePrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSJavaScriptCallFrame::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSJavaScriptCallFrame* thisObject = jsCast<JSJavaScriptCallFrame*>(cell);
...
bool JSJavaScriptCallFrame::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
{
    JSJavaScriptCallFrame* jsJavaScriptCallFrame = static_cast<JSJavaScriptCallFrame*>(handle.get().asCell());
