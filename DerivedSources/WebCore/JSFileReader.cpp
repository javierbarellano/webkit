...
const ClassInfo JSFileReaderConstructor::s_info = { "FileReaderConstructor", &Base::s_info, &JSFileReaderConstructorTable, 0, CREATE_METHOD_TABLE(JSFileReaderConstructor) };
...
bool JSFileReaderConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSFileReaderConstructor, JSDOMWrapper>(exec, &JSFileReaderConstructorTable, static_cast<JSFileReaderConstructor*>(cell), propertyName, slot);
}

bool JSFileReaderConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSFileReaderConstructor, JSDOMWrapper>(exec, &JSFileReaderConstructorTable, static_cast<JSFileReaderConstructor*>(object), propertyName, descriptor);
}

EncodedJSValue JSC_HOST_CALL JSFileReaderConstructor::constructJSFileReader(ExecState* exec)
{
    JSFileReaderConstructor* castedThis = static_cast<JSFileReaderConstructor*>(exec->callee());
...
bool JSFileReaderPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSFileReaderPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSFileReader::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSFileReader* thisObject = jsCast<JSFileReader*>(cell);
...
bool JSFileReader::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
void JSFileReader::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
    JSFileReader* thisObject = jsCast<JSFileReader*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
