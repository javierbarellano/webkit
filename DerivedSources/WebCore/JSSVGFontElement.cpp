...
bool JSSVGFontElementConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSVGFontElementConstructor, JSDOMWrapper>(exec, &JSSVGFontElementConstructorTable, static_cast<JSSVGFontElementConstructor*>(cell), propertyName, slot);
}

bool JSSVGFontElementConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSVGFontElementConstructor, JSDOMWrapper>(exec, &JSSVGFontElementConstructorTable, static_cast<JSSVGFontElementConstructor*>(object), propertyName, descriptor);
}
...
bool JSSVGFontElement::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSSVGFontElement::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
