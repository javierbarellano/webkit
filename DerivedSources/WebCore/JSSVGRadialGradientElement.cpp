...
bool JSSVGRadialGradientElementConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSVGRadialGradientElementConstructor, JSDOMWrapper>(exec, &JSSVGRadialGradientElementConstructorTable, static_cast<JSSVGRadialGradientElementConstructor*>(cell), propertyName, slot);
}

bool JSSVGRadialGradientElementConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSVGRadialGradientElementConstructor, JSDOMWrapper>(exec, &JSSVGRadialGradientElementConstructorTable, static_cast<JSSVGRadialGradientElementConstructor*>(object), propertyName, descriptor);
}
...
bool JSSVGRadialGradientElement::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSSVGRadialGradientElement::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
