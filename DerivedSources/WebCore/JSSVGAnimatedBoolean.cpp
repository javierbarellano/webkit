...
bool JSSVGAnimatedBooleanConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSVGAnimatedBooleanConstructor, JSDOMWrapper>(exec, &JSSVGAnimatedBooleanConstructorTable, static_cast<JSSVGAnimatedBooleanConstructor*>(cell), propertyName, slot);
}

bool JSSVGAnimatedBooleanConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSVGAnimatedBooleanConstructor, JSDOMWrapper>(exec, &JSSVGAnimatedBooleanConstructorTable, static_cast<JSSVGAnimatedBooleanConstructor*>(object), propertyName, descriptor);
}
...
bool JSSVGAnimatedBoolean::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSSVGAnimatedBoolean* thisObject = jsCast<JSSVGAnimatedBoolean*>(cell);
...
bool JSSVGAnimatedBoolean::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
void JSSVGAnimatedBoolean::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
    JSSVGAnimatedBoolean* thisObject = jsCast<JSSVGAnimatedBoolean*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
...
{
    JSSVGAnimatedBoolean* jsSVGAnimatedBoolean = static_cast<JSSVGAnimatedBoolean*>(handle.get().asCell());
