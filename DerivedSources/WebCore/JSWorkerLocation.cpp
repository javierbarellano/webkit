...
const ClassInfo JSWorkerLocationConstructor::s_info = { "WorkerLocationConstructor", &Base::s_info, &JSWorkerLocationConstructorTable, 0, CREATE_METHOD_TABLE(JSWorkerLocationConstructor) };
...
bool JSWorkerLocationConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSWorkerLocationConstructor, JSDOMWrapper>(exec, &JSWorkerLocationConstructorTable, static_cast<JSWorkerLocationConstructor*>(cell), propertyName, slot);
}

bool JSWorkerLocationConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSWorkerLocationConstructor, JSDOMWrapper>(exec, &JSWorkerLocationConstructorTable, static_cast<JSWorkerLocationConstructor*>(object), propertyName, descriptor);
}
...
bool JSWorkerLocationPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSWorkerLocationPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSWorkerLocation::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSWorkerLocation* thisObject = jsCast<JSWorkerLocation*>(cell);
...
bool JSWorkerLocation::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
