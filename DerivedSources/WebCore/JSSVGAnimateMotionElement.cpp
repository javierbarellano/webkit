...
bool JSSVGAnimateMotionElementConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSVGAnimateMotionElementConstructor, JSDOMWrapper>(exec, &JSSVGAnimateMotionElementConstructorTable, static_cast<JSSVGAnimateMotionElementConstructor*>(cell), propertyName, slot);
}

bool JSSVGAnimateMotionElementConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSVGAnimateMotionElementConstructor, JSDOMWrapper>(exec, &JSSVGAnimateMotionElementConstructorTable, static_cast<JSSVGAnimateMotionElementConstructor*>(object), propertyName, descriptor);
}
...
bool JSSVGAnimateMotionElement::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSSVGAnimateMotionElement::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
