...
JSC::JSValue jsWebKitCSSRegionRuleCssRules(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsWebKitCSSRegionRuleConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
