...
bool JSHTMLUnknownElementConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSHTMLUnknownElementConstructor, JSDOMWrapper>(exec, &JSHTMLUnknownElementConstructorTable, static_cast<JSHTMLUnknownElementConstructor*>(cell), propertyName, slot);
}

bool JSHTMLUnknownElementConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSHTMLUnknownElementConstructor, JSDOMWrapper>(exec, &JSHTMLUnknownElementConstructorTable, static_cast<JSHTMLUnknownElementConstructor*>(object), propertyName, descriptor);
}
...
bool JSHTMLUnknownElement::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSHTMLUnknownElement::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
