...
static const HashTableValue JSScriptProfileNodeTableValues[] =
{
    ...
    { "children", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsScriptProfileNodeChildren), (intptr_t)0, NoIntrinsic },
...
static const HashTable JSScriptProfileNodeTable = { 35, 31, JSScriptProfileNodeTableValues, 0 };
...
static const HashTable JSScriptProfileNodePrototypeTable = { 1, 0, JSScriptProfileNodePrototypeTableValues, 0 };
...
bool JSScriptProfileNode::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSScriptProfileNode* thisObject = jsCast<JSScriptProfileNode*>(cell);
...
bool JSScriptProfileNode::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
JSValue jsScriptProfileNodeFunctionName(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    JSValue result = jsString(exec, impl->functionName());
    return result;
}
...
{
    JSScriptProfileNode* jsScriptProfileNode = static_cast<JSScriptProfileNode*>(handle.get().asCell());
