...
bool JSSVGPathSegCurvetoCubicAbsConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSVGPathSegCurvetoCubicAbsConstructor, JSDOMWrapper>(exec, &JSSVGPathSegCurvetoCubicAbsConstructorTable, static_cast<JSSVGPathSegCurvetoCubicAbsConstructor*>(cell), propertyName, slot);
}

bool JSSVGPathSegCurvetoCubicAbsConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSVGPathSegCurvetoCubicAbsConstructor, JSDOMWrapper>(exec, &JSSVGPathSegCurvetoCubicAbsConstructorTable, static_cast<JSSVGPathSegCurvetoCubicAbsConstructor*>(object), propertyName, descriptor);
}
...
bool JSSVGPathSegCurvetoCubicAbs::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSSVGPathSegCurvetoCubicAbs::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
void JSSVGPathSegCurvetoCubicAbs::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
    JSSVGPathSegCurvetoCubicAbs* thisObject = jsCast<JSSVGPathSegCurvetoCubicAbs*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
