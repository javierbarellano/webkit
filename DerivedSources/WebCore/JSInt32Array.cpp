...
{
    return getStaticValueSlot<JSInt32ArrayConstructor, JSDOMWrapper>(exec, &JSInt32ArrayConstructorTable, static_cast<JSInt32ArrayConstructor*>(cell), propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSInt32ArrayConstructor, JSDOMWrapper>(exec, &JSInt32ArrayConstructorTable, static_cast<JSInt32ArrayConstructor*>(object), propertyName, descriptor);
}
