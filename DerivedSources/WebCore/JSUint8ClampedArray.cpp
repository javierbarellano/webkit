...
{
    return getStaticValueSlot<JSUint8ClampedArrayConstructor, JSDOMWrapper>(exec, &JSUint8ClampedArrayConstructorTable, static_cast<JSUint8ClampedArrayConstructor*>(cell), propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSUint8ClampedArrayConstructor, JSDOMWrapper>(exec, &JSUint8ClampedArrayConstructorTable, static_cast<JSUint8ClampedArrayConstructor*>(object), propertyName, descriptor);
}
...
{
    JSUint8ClampedArray* castedThis = static_cast<JSUint8ClampedArray*>(asObject(slotBase));
    UNUSED_PARAM(exec);
...
{
    JSUint8ClampedArray* domObject = static_cast<JSUint8ClampedArray*>(asObject(slotBase));
...
{
    return getDOMConstructor<JSUint8ClampedArrayConstructor>(exec, static_cast<JSDOMGlobalObject*>(globalObject));
}
...
EncodedJSValue JSC_HOST_CALL jsUint8ClampedArrayPrototypeFunctionSubarray(ExecState* exec)
{
    ...
    JSUint8ClampedArray* castedThis = static_cast<JSUint8ClampedArray*>(asObject(thisValue));
...
{
    return value.inherits(&JSUint8ClampedArray::s_info) ? static_cast<JSUint8ClampedArray*>(asObject(value))->impl() : 0;
}
