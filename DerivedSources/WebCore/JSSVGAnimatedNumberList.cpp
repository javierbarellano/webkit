...
bool JSSVGAnimatedNumberListConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSVGAnimatedNumberListConstructor, JSDOMWrapper>(exec, &JSSVGAnimatedNumberListConstructorTable, static_cast<JSSVGAnimatedNumberListConstructor*>(cell), propertyName, slot);
}

bool JSSVGAnimatedNumberListConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSVGAnimatedNumberListConstructor, JSDOMWrapper>(exec, &JSSVGAnimatedNumberListConstructorTable, static_cast<JSSVGAnimatedNumberListConstructor*>(object), propertyName, descriptor);
}
...
bool JSSVGAnimatedNumberList::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSSVGAnimatedNumberList* thisObject = jsCast<JSSVGAnimatedNumberList*>(cell);
...
bool JSSVGAnimatedNumberList::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
{
    JSSVGAnimatedNumberList* jsSVGAnimatedNumberList = static_cast<JSSVGAnimatedNumberList*>(handle.get().asCell());
