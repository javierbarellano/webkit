...
{
    { "executeSql", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsSQLTransactionPrototypeFunctionExecuteSql), (intptr_t)4, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
bool JSSQLTransactionPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSSQLTransactionPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
{
    JSSQLTransaction* thisObject = jsCast<JSSQLTransaction*>(cell);
...
{
    JSSQLTransaction* jsSQLTransaction = static_cast<JSSQLTransaction*>(handle.get().asCell());
