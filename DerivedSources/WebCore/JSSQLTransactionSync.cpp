...
bool JSSQLTransactionSyncPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSSQLTransactionSyncPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
{
    JSSQLTransactionSync* thisObject = jsCast<JSSQLTransactionSync*>(cell);
...
{
    JSSQLTransactionSync* jsSQLTransactionSync = static_cast<JSSQLTransactionSync*>(handle.get().asCell());
