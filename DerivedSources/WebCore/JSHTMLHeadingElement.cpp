...
bool JSHTMLHeadingElementConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSHTMLHeadingElementConstructor, JSDOMWrapper>(exec, &JSHTMLHeadingElementConstructorTable, static_cast<JSHTMLHeadingElementConstructor*>(cell), propertyName, slot);
}

bool JSHTMLHeadingElementConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSHTMLHeadingElementConstructor, JSDOMWrapper>(exec, &JSHTMLHeadingElementConstructorTable, static_cast<JSHTMLHeadingElementConstructor*>(object), propertyName, descriptor);
}
...
bool JSHTMLHeadingElement::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSHTMLHeadingElement::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
void JSHTMLHeadingElement::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
    JSHTMLHeadingElement* thisObject = jsCast<JSHTMLHeadingElement*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
