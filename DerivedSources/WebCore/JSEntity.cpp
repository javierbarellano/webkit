...
bool JSEntityConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSEntityConstructor, JSDOMWrapper>(exec, &JSEntityConstructorTable, static_cast<JSEntityConstructor*>(cell), propertyName, slot);
}

bool JSEntityConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSEntityConstructor, JSDOMWrapper>(exec, &JSEntityConstructorTable, static_cast<JSEntityConstructor*>(object), propertyName, descriptor);
}
...
bool JSEntity::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSEntity::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
