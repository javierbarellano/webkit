...
JSC::JSValue jsHTMLTextAreaElementDirName(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
...
JSC::JSValue jsHTMLTextAreaElementWrap(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
