...
JSC::JSValue jsAudioPannerNodeLINEAR_DISTANCE(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsAudioPannerNodeINVERSE_DISTANCE(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsAudioPannerNodeEXPONENTIAL_DISTANCE(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
