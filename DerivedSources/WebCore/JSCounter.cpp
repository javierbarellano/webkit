...
bool JSCounterConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSCounterConstructor, JSDOMWrapper>(exec, &JSCounterConstructorTable, static_cast<JSCounterConstructor*>(cell), propertyName, slot);
}

bool JSCounterConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSCounterConstructor, JSDOMWrapper>(exec, &JSCounterConstructorTable, static_cast<JSCounterConstructor*>(object), propertyName, descriptor);
}
...
bool JSCounter::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSCounter* thisObject = jsCast<JSCounter*>(cell);
...
bool JSCounter::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
JSValue jsCounterIdentifier(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    JSValue result = jsString(exec, impl->identifier());
    return result;
}
...
JSValue jsCounterListStyle(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    Counter* impl = static_cast<Counter*>(castedThis->impl());
    JSValue result = jsString(exec, impl->listStyle());
    return result;
}
...
JSValue jsCounterSeparator(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    Counter* impl = static_cast<Counter*>(castedThis->impl());
    JSValue result = jsString(exec, impl->separator());
    return result;
}
...
{
    JSCounter* jsCounter = static_cast<JSCounter*>(handle.get().asCell());
