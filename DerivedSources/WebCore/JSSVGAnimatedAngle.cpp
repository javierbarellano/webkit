...
bool JSSVGAnimatedAngleConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSVGAnimatedAngleConstructor, JSDOMWrapper>(exec, &JSSVGAnimatedAngleConstructorTable, static_cast<JSSVGAnimatedAngleConstructor*>(cell), propertyName, slot);
}

bool JSSVGAnimatedAngleConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSVGAnimatedAngleConstructor, JSDOMWrapper>(exec, &JSSVGAnimatedAngleConstructorTable, static_cast<JSSVGAnimatedAngleConstructor*>(object), propertyName, descriptor);
}
...
bool JSSVGAnimatedAngle::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSSVGAnimatedAngle* thisObject = jsCast<JSSVGAnimatedAngle*>(cell);
...
bool JSSVGAnimatedAngle::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
{
    JSSVGAnimatedAngle* jsSVGAnimatedAngle = static_cast<JSSVGAnimatedAngle*>(handle.get().asCell());
