...
static const HashTableValue JSDocumentTableValues[] =
{
    ...
    { "documentURI", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDocumentDocumentURI), (intptr_t)setJSDocumentDocumentURI, NoIntrinsic },
...
static const HashTable JSDocumentTable = { 265, 255, JSDocumentTableValues, 0 };
...
bool JSDocumentConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSDocumentConstructor, JSDOMWrapper>(exec, &JSDocumentConstructorTable, static_cast<JSDocumentConstructor*>(cell), propertyName, slot);
}

bool JSDocumentConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSDocumentConstructor, JSDOMWrapper>(exec, &JSDocumentConstructorTable, static_cast<JSDocumentConstructor*>(object), propertyName, descriptor);
}
...
static const HashTableValue JSDocumentPrototypeTableValues[] =
{
    ...
    { "webkitGetFlowByName", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsDocumentPrototypeFunctionWebkitGetFlowByName), (intptr_t)1, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
bool JSDocumentPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSDocumentPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
JSValue jsDocumentReferrer(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    Document* impl = static_cast<Document*>(castedThis->impl());
    JSValue result = jsString(exec, impl->referrer());
    return result;
}
...
JSValue jsDocumentDomain(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    Document* impl = static_cast<Document*>(castedThis->impl());
    JSValue result = jsString(exec, impl->domain());
    return result;
}
...
JSValue jsDocumentCookie(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    ExceptionCode ec = 0;
    Document* impl = static_cast<Document*>(castedThis->impl());
    JSC::JSValue result = jsString(exec, impl->cookie(ec));
...
JSValue jsDocumentLastModified(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    Document* impl = static_cast<Document*>(castedThis->impl());
    JSValue result = jsString(exec, impl->lastModified());
    return result;
}
...
JSValue jsDocumentWebkitIsFullScreen(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDocument* castedThis = static_cast<JSDocument*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    Document* impl = static_cast<Document*>(castedThis->impl());
...
JSValue jsDocumentWebkitFullScreenKeyboardInputAllowed(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDocument* castedThis = static_cast<JSDocument*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    Document* impl = static_cast<Document*>(castedThis->impl());
...
JSValue jsDocumentWebkitCurrentFullScreenElement(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDocument* castedThis = static_cast<JSDocument*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    Document* impl = static_cast<Document*>(castedThis->impl());
...
JSValue jsDocumentWebkitFullscreenEnabled(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDocument* castedThis = static_cast<JSDocument*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    Document* impl = static_cast<Document*>(castedThis->impl());
...
JSValue jsDocumentWebkitFullscreenElement(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDocument* castedThis = static_cast<JSDocument*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    Document* impl = static_cast<Document*>(castedThis->impl());
...
#if ENABLE(FULLSCREEN_API)
JSValue jsDocumentOnwebkitfullscreenerror(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDocument* castedThis = static_cast<JSDocument*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    Document* impl = static_cast<Document*>(castedThis->impl());
...
JSValue jsDocumentWebkitVisibilityState(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    Document* impl = static_cast<Document*>(castedThis->impl());
    JSValue result = jsString(exec, impl->webkitVisibilityState());
    return result;
}
...
void JSDocument::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
...
void setJSDocumentDocumentURI(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSDocument* castedThis = static_cast<JSDocument*>(thisObject);
    Document* impl = static_cast<Document*>(castedThis->impl());
    impl->setDocumentURI(valueToStringWithNullCheck(exec, value));
}
...
EncodedJSValue JSC_HOST_CALL jsDocumentPrototypeFunctionCreateProcessingInstruction(ExecState* exec)
{
    ...
    Document* impl = static_cast<Document*>(castedThis->impl());
    ExceptionCode ec = 0;
    const String& target(ustringToString(MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
...
EncodedJSValue JSC_HOST_CALL jsDocumentPrototypeFunctionCreateEvent(ExecState* exec)
{
    ...
    Document* impl = static_cast<Document*>(castedThis->impl());
    ExceptionCode ec = 0;
    const String& eventType(ustringToString(MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
...
EncodedJSValue JSC_HOST_CALL jsDocumentPrototypeFunctionExecCommand(ExecState* exec)
{
    ...
    ASSERT_GC_OBJECT_INHERITS(castedThis, &JSDocument::s_info);
    Document* impl = static_cast<Document*>(castedThis->impl());
    const String& command(ustringToString(MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
...
EncodedJSValue JSC_HOST_CALL jsDocumentPrototypeFunctionQueryCommandValue(ExecState* exec)
{
    ...
    JSC::JSValue result = jsStringOrFalse(exec, impl->queryCommandValue(command));
    return JSValue::encode(result);
}
...
EncodedJSValue JSC_HOST_CALL jsDocumentPrototypeFunctionGetElementsByName(ExecState* exec)
{
    ...
    ASSERT_GC_OBJECT_INHERITS(castedThis, &JSDocument::s_info);
    Document* impl = static_cast<Document*>(castedThis->impl());
    const String& elementName(ustringToString(MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
...
EncodedJSValue JSC_HOST_CALL jsDocumentPrototypeFunctionGetCSSCanvasContext(ExecState* exec)
{
    ...
    if (exec->argumentCount() < 4)
        return throwVMError(exec, createTypeError(exec, "Not enough arguments"));
    const String& contextId(ustringToString(MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    const String& name(ustringToString(MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
...
EncodedJSValue JSC_HOST_CALL jsDocumentPrototypeFunctionWebkitGetFlowByName(ExecState* exec)
{
    JSValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(&JSDocument::s_info))
        return throwVMTypeError(exec);
    ...
    JSC::JSValue result = toJS(exec, castedThis->globalObject(), WTF::getPtr(impl->webkitGetFlowByName(name)));
    return JSValue::encode(result);
}
