...
JSC::JSValue jsMouseEventWebkitMovementX(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
#endif
#if ENABLE(POINTER_LOCK)
JSC::JSValue jsMouseEventWebkitMovementY(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
#endif
