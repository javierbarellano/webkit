...
static const HashTable JSEventConstructorTable = { 68, 63, JSEventConstructorTableValues, 0 };
...
const ClassInfo JSEventConstructor::s_info = { "EventConstructor", &Base::s_info, &JSEventConstructorTable, 0, CREATE_METHOD_TABLE(JSEventConstructor) };
...
bool JSEventConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSEventConstructor, JSDOMWrapper>(exec, &JSEventConstructorTable, static_cast<JSEventConstructor*>(cell), propertyName, slot);
}

bool JSEventConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSEventConstructor, JSDOMWrapper>(exec, &JSEventConstructorTable, static_cast<JSEventConstructor*>(object), propertyName, descriptor);
}

EncodedJSValue JSC_HOST_CALL JSEventConstructor::constructJSEvent(ExecState* exec)
{
    JSEventConstructor* jsConstructor = static_cast<JSEventConstructor*>(exec->callee());
...
static const HashTable JSEventPrototypeTable = { 69, 63, JSEventPrototypeTableValues, 0 };
...
bool JSEventPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSEventPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSEvent::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSEvent* thisObject = jsCast<JSEvent*>(cell);
...
bool JSEvent::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
void JSEvent::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
    JSEvent* thisObject = jsCast<JSEvent*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
...
EncodedJSValue JSC_HOST_CALL jsEventPrototypeFunctionInitEvent(ExecState* exec)
{
    ...
    ASSERT_GC_OBJECT_INHERITS(castedThis, &JSEvent::s_info);
    Event* impl = static_cast<Event*>(castedThis->impl());
    const String& eventTypeArg(ustringToString(MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
...
{
    JSEvent* jsEvent = static_cast<JSEvent*>(handle.get().asCell());
