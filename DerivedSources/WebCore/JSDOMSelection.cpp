...
bool JSDOMSelectionConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSDOMSelectionConstructor, JSDOMWrapper>(exec, &JSDOMSelectionConstructorTable, static_cast<JSDOMSelectionConstructor*>(cell), propertyName, slot);
}

bool JSDOMSelectionConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSDOMSelectionConstructor, JSDOMWrapper>(exec, &JSDOMSelectionConstructorTable, static_cast<JSDOMSelectionConstructor*>(object), propertyName, descriptor);
}
...
bool JSDOMSelectionPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSDOMSelectionPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSDOMSelection::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSDOMSelection* thisObject = jsCast<JSDOMSelection*>(cell);
...
bool JSDOMSelection::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
JSValue jsDOMSelectionConstructor(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDOMSelection* domObject = static_cast<JSDOMSelection*>(asObject(slotBase));
...
{
    return getDOMConstructor<JSDOMSelectionConstructor>(exec, static_cast<JSDOMGlobalObject*>(globalObject));
}
...
EncodedJSValue JSC_HOST_CALL jsDOMSelectionPrototypeFunctionModify(ExecState* exec)
{
    ...
    ASSERT_GC_OBJECT_INHERITS(castedThis, &JSDOMSelection::s_info);
    DOMSelection* impl = static_cast<DOMSelection*>(castedThis->impl());
    const String& alter(ustringToString(MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    const String& direction(ustringToString(MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    const String& granularity(ustringToString(MAYBE_MISSING_PARAMETER(exec, 2, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 2, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
