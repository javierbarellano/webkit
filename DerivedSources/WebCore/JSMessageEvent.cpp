...
const ClassInfo JSMessageEventConstructor::s_info = { "MessageEventConstructor", &Base::s_info, &JSMessageEventConstructorTable, 0, CREATE_METHOD_TABLE(JSMessageEventConstructor) };
...
bool JSMessageEventConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSMessageEventConstructor, JSDOMWrapper>(exec, &JSMessageEventConstructorTable, static_cast<JSMessageEventConstructor*>(cell), propertyName, slot);
}

bool JSMessageEventConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSMessageEventConstructor, JSDOMWrapper>(exec, &JSMessageEventConstructorTable, static_cast<JSMessageEventConstructor*>(object), propertyName, descriptor);
}

EncodedJSValue JSC_HOST_CALL JSMessageEventConstructor::constructJSMessageEvent(ExecState* exec)
{
    JSMessageEventConstructor* jsConstructor = static_cast<JSMessageEventConstructor*>(exec->callee());
...
bool JSMessageEventPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSMessageEventPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSMessageEvent::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSMessageEvent::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
JSValue jsMessageEventLastEventId(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    MessageEvent* impl = static_cast<MessageEvent*>(castedThis->impl());
    JSValue result = jsString(exec, impl->lastEventId());
    return result;
}
