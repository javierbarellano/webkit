...
bool JSNodeFilterConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSNodeFilterConstructor, JSDOMWrapper>(exec, &JSNodeFilterConstructorTable, static_cast<JSNodeFilterConstructor*>(cell), propertyName, slot);
}

bool JSNodeFilterConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSNodeFilterConstructor, JSDOMWrapper>(exec, &JSNodeFilterConstructorTable, static_cast<JSNodeFilterConstructor*>(object), propertyName, descriptor);
}
...
bool JSNodeFilterPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSNodeFilterPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSNodeFilter::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSNodeFilter* thisObject = jsCast<JSNodeFilter*>(cell);
...
bool JSNodeFilter::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
{
    JSNodeFilter* jsNodeFilter = static_cast<JSNodeFilter*>(handle.get().asCell());
