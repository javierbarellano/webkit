...
const ClassInfo JSFileErrorConstructor::s_info = { "FileErrorConstructor", &Base::s_info, &JSFileErrorConstructorTable, 0, CREATE_METHOD_TABLE(JSFileErrorConstructor) };
...
bool JSFileErrorConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSFileErrorConstructor, JSDOMWrapper>(exec, &JSFileErrorConstructorTable, static_cast<JSFileErrorConstructor*>(cell), propertyName, slot);
}

bool JSFileErrorConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSFileErrorConstructor, JSDOMWrapper>(exec, &JSFileErrorConstructorTable, static_cast<JSFileErrorConstructor*>(object), propertyName, descriptor);
}
...
bool JSFileErrorPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSFileErrorPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSFileError::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSFileError* thisObject = jsCast<JSFileError*>(cell);
...
bool JSFileError::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
{
    JSFileError* jsFileError = static_cast<JSFileError*>(handle.get().asCell());
