...
bool JSSVGPathSegCurvetoCubicSmoothAbsConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSVGPathSegCurvetoCubicSmoothAbsConstructor, JSDOMWrapper>(exec, &JSSVGPathSegCurvetoCubicSmoothAbsConstructorTable, static_cast<JSSVGPathSegCurvetoCubicSmoothAbsConstructor*>(cell), propertyName, slot);
}

bool JSSVGPathSegCurvetoCubicSmoothAbsConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSVGPathSegCurvetoCubicSmoothAbsConstructor, JSDOMWrapper>(exec, &JSSVGPathSegCurvetoCubicSmoothAbsConstructorTable, static_cast<JSSVGPathSegCurvetoCubicSmoothAbsConstructor*>(object), propertyName, descriptor);
}
...
bool JSSVGPathSegCurvetoCubicSmoothAbs::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSSVGPathSegCurvetoCubicSmoothAbs::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
void JSSVGPathSegCurvetoCubicSmoothAbs::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
    JSSVGPathSegCurvetoCubicSmoothAbs* thisObject = jsCast<JSSVGPathSegCurvetoCubicSmoothAbs*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
