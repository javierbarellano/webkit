...
bool JSSVGRectConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSVGRectConstructor, JSDOMWrapper>(exec, &JSSVGRectConstructorTable, static_cast<JSSVGRectConstructor*>(cell), propertyName, slot);
}

bool JSSVGRectConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSVGRectConstructor, JSDOMWrapper>(exec, &JSSVGRectConstructorTable, static_cast<JSSVGRectConstructor*>(object), propertyName, descriptor);
}
...
bool JSSVGRect::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSSVGRect* thisObject = jsCast<JSSVGRect*>(cell);
...
bool JSSVGRect::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
void JSSVGRect::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
    JSSVGRect* thisObject = jsCast<JSSVGRect*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
...
{
    JSSVGRect* jsSVGRect = static_cast<JSSVGRect*>(handle.get().asCell());
