...
bool JSHTMLVideoElementConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSHTMLVideoElementConstructor, JSDOMWrapper>(exec, &JSHTMLVideoElementConstructorTable, static_cast<JSHTMLVideoElementConstructor*>(cell), propertyName, slot);
}

bool JSHTMLVideoElementConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSHTMLVideoElementConstructor, JSDOMWrapper>(exec, &JSHTMLVideoElementConstructorTable, static_cast<JSHTMLVideoElementConstructor*>(object), propertyName, descriptor);
}
...
bool JSHTMLVideoElementPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSHTMLVideoElementPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSHTMLVideoElement::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSHTMLVideoElement::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
JSValue jsHTMLVideoElementPoster(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    HTMLVideoElement* impl = static_cast<HTMLVideoElement*>(castedThis->impl());
    JSValue result = jsString(exec, impl->getURLAttribute(WebCore::HTMLNames::posterAttr));
    return result;
}
...
void JSHTMLVideoElement::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
    JSHTMLVideoElement* thisObject = jsCast<JSHTMLVideoElement*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
...
void setJSHTMLVideoElementWidth(ExecState* exec, JSObject* thisObject, JSValue value)
{
    ...
    HTMLVideoElement* impl = static_cast<HTMLVideoElement*>(castedThis->impl());
    impl->setUnsignedIntegralAttribute(WebCore::HTMLNames::widthAttr, value.toUInt32(exec));
}
...
void setJSHTMLVideoElementHeight(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSHTMLVideoElement* castedThis = static_cast<JSHTMLVideoElement*>(thisObject);
    HTMLVideoElement* impl = static_cast<HTMLVideoElement*>(castedThis->impl());
    impl->setUnsignedIntegralAttribute(WebCore::HTMLNames::heightAttr, value.toUInt32(exec));
}
...
void setJSHTMLVideoElementPoster(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSHTMLVideoElement* castedThis = static_cast<JSHTMLVideoElement*>(thisObject);
    HTMLVideoElement* impl = static_cast<HTMLVideoElement*>(castedThis->impl());
    impl->setAttribute(WebCore::HTMLNames::posterAttr, valueToStringWithNullCheck(exec, value));
}
