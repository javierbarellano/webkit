...
JSC::JSValue jsWaveShaperNodeCurve(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSWaveShaperNodeCurve(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsWaveShaperNodeConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
