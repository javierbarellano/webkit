...
{
    return getStaticValueSlot<JSArrayBufferConstructor, JSDOMWrapper>(exec, &JSArrayBufferConstructorTable, static_cast<JSArrayBufferConstructor*>(cell), propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSArrayBufferConstructor, JSDOMWrapper>(exec, &JSArrayBufferConstructorTable, static_cast<JSArrayBufferConstructor*>(object), propertyName, descriptor);
}
...
EncodedJSValue JSC_HOST_CALL jsArrayBufferPrototypeFunctionSlice(ExecState* exec)
{
    ...
    JSArrayBuffer* castedThis = static_cast<JSArrayBuffer*>(asObject(thisValue));
