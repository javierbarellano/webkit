...
bool JSGeoposition::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSGeoposition* thisObject = jsCast<JSGeoposition*>(cell);
...
bool JSGeoposition::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
{
    JSGeoposition* jsGeoposition = static_cast<JSGeoposition*>(handle.get().asCell());
