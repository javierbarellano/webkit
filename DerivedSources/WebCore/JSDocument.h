...
JSC::JSValue jsDocumentWebkitFullscreenEnabled(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsDocumentWebkitFullscreenElement(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
