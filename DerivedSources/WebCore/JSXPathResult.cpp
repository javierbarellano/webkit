...
bool JSXPathResultConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSXPathResultConstructor, JSDOMWrapper>(exec, &JSXPathResultConstructorTable, static_cast<JSXPathResultConstructor*>(cell), propertyName, slot);
}

bool JSXPathResultConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSXPathResultConstructor, JSDOMWrapper>(exec, &JSXPathResultConstructorTable, static_cast<JSXPathResultConstructor*>(object), propertyName, descriptor);
}
...
bool JSXPathResultPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSXPathResultPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSXPathResult::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSXPathResult* thisObject = jsCast<JSXPathResult*>(cell);
...
bool JSXPathResult::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
JSValue jsXPathResultStringValue(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    ExceptionCode ec = 0;
    XPathResult* impl = static_cast<XPathResult*>(castedThis->impl());
    JSC::JSValue result = jsString(exec, impl->stringValue(ec));
    setDOMException(exec, ec);
    return result;
}
...
{
    JSXPathResult* jsXPathResult = static_cast<JSXPathResult*>(handle.get().asCell());
