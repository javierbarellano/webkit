...
public:
    ...
    public:
        virtual void getDOMNodeCount(ErrorString*, /*RefPtr<TypeBuilder::Array<TypeBuilder::Memory::DOMGroup> >&*/ RefPtr<InspectorArray>& out_domGroups, /*RefPtr<TypeBuilder::Memory::StringStatistics>&*/ RefPtr<InspectorObject>& out_strings) = 0;
    ...
    public:
        ...
        virtual void setScreenSizeOverride(ErrorString*, int in_width, int in_height) = 0;
    ...
    public:
        virtual void evaluate(ErrorString*, const String& in_expression, const String* in_objectGroup, const bool* in_includeCommandLineAPI, const bool* in_doNotPauseOnExceptions, const String* in_frameId, const bool* in_returnByValue, RefPtr<TypeBuilder::Runtime::RemoteObject>& out_result, TypeBuilder::OptOutput<bool>* opt_out_wasThrown) = 0;
        virtual void callFunctionOn(ErrorString*, const String& in_objectId, const String& in_functionDeclaration, const RefPtr<InspectorArray>* in_arguments, const bool* in_returnByValue, RefPtr<TypeBuilder::Runtime::RemoteObject>& out_result, TypeBuilder::OptOutput<bool>* opt_out_wasThrown) = 0;
    ...
    public:
        virtual void enable(ErrorString*) = 0;
        virtual void disable(ErrorString*) = 0;
        virtual void getDatabaseTableNames(ErrorString*, int in_databaseId, /*RefPtr<TypeBuilder::Array<String> >&*/ RefPtr<InspectorArray>& out_tableNames) = 0;
        virtual void executeSQL(ErrorString*, int in_databaseId, const String& in_query, bool* out_success, int* out_transactionId) = 0;
    ...
    public:
        virtual void enable(ErrorString*) = 0;
        virtual void disable(ErrorString*) = 0;
        virtual void getDOMStorageEntries(ErrorString*, int in_storageId, /*RefPtr<TypeBuilder::Array<TypeBuilder::DOMStorage::Entry> >&*/ RefPtr<InspectorArray>& out_entries) = 0;
        virtual void setDOMStorageItem(ErrorString*, int in_storageId, const String& in_key, const String& in_value, bool* out_success) = 0;
        virtual void removeDOMStorageItem(ErrorString*, int in_storageId, const String& in_key, bool* out_success) = 0;
    ...
    public:
        virtual void getFramesWithManifests(ErrorString*, /*RefPtr<TypeBuilder::Array<TypeBuilder::ApplicationCache::FrameWithManifest> >&*/ RefPtr<InspectorArray>& out_frameIds) = 0;
        virtual void enable(ErrorString*) = 0;
        virtual void getManifestForFrame(ErrorString*, const String& in_frameId, String* out_manifestURL) = 0;
        virtual void getApplicationCacheForFrame(ErrorString*, const String& in_frameId, /*RefPtr<TypeBuilder::ApplicationCache::ApplicationCache>&*/ RefPtr<InspectorObject>& out_applicationCache) = 0;
    ...
    public:
        ...
        virtual void setBreakpointByUrl(ErrorString*, int in_lineNumber, const String* in_url, const String* in_urlRegex, const int* in_columnNumber, const String* in_condition, TypeBuilder::Debugger::BreakpointId* out_breakpointId, RefPtr<TypeBuilder::Array<TypeBuilder::Debugger::Location> >& opt_out_locations) = 0;
        ...
        virtual void evaluateOnCallFrame(ErrorString*, const String& in_callFrameId, const String& in_expression, const String* in_objectGroup, const bool* in_includeCommandLineAPI, const bool* in_returnByValue, RefPtr<TypeBuilder::Runtime::RemoteObject>& out_result, TypeBuilder::OptOutput<bool>* opt_out_wasThrown) = 0;
    ...
    public:
        ...
        virtual void stop(ErrorString*) = 0;
        virtual void getProfileHeaders(ErrorString*, /*RefPtr<TypeBuilder::Array<InspectorObject> >&*/ RefPtr<InspectorArray>& out_headers) = 0;
        virtual void getProfile(ErrorString*, const String& in_type, int in_uid, RefPtr<InspectorObject>& out_profile) = 0;
        ...
        virtual void getObjectByHeapObjectId(ErrorString*, int in_objectId, const String* in_objectGroup, /*RefPtr<TypeBuilder::Runtime::RemoteObject>&*/ RefPtr<InspectorObject>& out_result) = 0;
