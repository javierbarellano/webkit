...
#if ENABLE(BLOB)
JSC::JSValue jsWorkerContextWebkitURLConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
...
JSC::JSValue jsWorkerContextUint8ClampedArrayConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
