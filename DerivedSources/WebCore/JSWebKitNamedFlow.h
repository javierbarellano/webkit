...
JSC::JSValue jsWebKitNamedFlowOverflow(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsWebKitNamedFlowConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
