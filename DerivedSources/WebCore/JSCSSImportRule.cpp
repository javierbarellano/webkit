...
bool JSCSSImportRuleConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSCSSImportRuleConstructor, JSDOMWrapper>(exec, &JSCSSImportRuleConstructorTable, static_cast<JSCSSImportRuleConstructor*>(cell), propertyName, slot);
}

bool JSCSSImportRuleConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSCSSImportRuleConstructor, JSDOMWrapper>(exec, &JSCSSImportRuleConstructorTable, static_cast<JSCSSImportRuleConstructor*>(object), propertyName, descriptor);
}
...
bool JSCSSImportRule::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSCSSImportRule::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
