...
JSC::EncodedJSValue JSC_HOST_CALL jsNavigatorPrototypeFunctionGetNetworkServices(JSC::ExecState*);
JSC::EncodedJSValue JSC_HOST_CALL jsNavigatorPrototypeFunctionOnNetworkServices(JSC::ExecState*);
JSC::EncodedJSValue JSC_HOST_CALL jsNavigatorPrototypeFunctionOnNetworkEvent(JSC::ExecState*);
