...
bool JSSVGPathSegConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSVGPathSegConstructor, JSDOMWrapper>(exec, &JSSVGPathSegConstructorTable, static_cast<JSSVGPathSegConstructor*>(cell), propertyName, slot);
}

bool JSSVGPathSegConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSVGPathSegConstructor, JSDOMWrapper>(exec, &JSSVGPathSegConstructorTable, static_cast<JSSVGPathSegConstructor*>(object), propertyName, descriptor);
}
...
bool JSSVGPathSegPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSSVGPathSegPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSSVGPathSeg::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSSVGPathSeg* thisObject = jsCast<JSSVGPathSeg*>(cell);
...
bool JSSVGPathSeg::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
JSValue jsSVGPathSegPathSegTypeAsLetter(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    SVGPathSeg* impl = static_cast<SVGPathSeg*>(castedThis->impl());
    JSValue result = jsString(exec, impl->pathSegTypeAsLetter());
    return result;
}
...
{
    JSSVGPathSeg* jsSVGPathSeg = static_cast<JSSVGPathSeg*>(handle.get().asCell());
