...
{
    return getStaticValueSlot<JSInt8ArrayConstructor, JSDOMWrapper>(exec, &JSInt8ArrayConstructorTable, static_cast<JSInt8ArrayConstructor*>(cell), propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSInt8ArrayConstructor, JSDOMWrapper>(exec, &JSInt8ArrayConstructorTable, static_cast<JSInt8ArrayConstructor*>(object), propertyName, descriptor);
}
