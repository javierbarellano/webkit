...
bool JSCoordinates::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSCoordinates* thisObject = jsCast<JSCoordinates*>(cell);
...
bool JSCoordinates::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
{
    JSCoordinates* jsCoordinates = static_cast<JSCoordinates*>(handle.get().asCell());
