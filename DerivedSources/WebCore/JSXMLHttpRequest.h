...
JSC::JSValue jsXMLHttpRequestOnloadend(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
...
JSC::JSValue jsXMLHttpRequestAsBlob(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
...
#if ENABLE(XHR_RESPONSE_BLOB)
JSC::JSValue jsXMLHttpRequestResponseBlob(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
#endif
