...
bool JSSVGMissingGlyphElementConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSVGMissingGlyphElementConstructor, JSDOMWrapper>(exec, &JSSVGMissingGlyphElementConstructorTable, static_cast<JSSVGMissingGlyphElementConstructor*>(cell), propertyName, slot);
}

bool JSSVGMissingGlyphElementConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSVGMissingGlyphElementConstructor, JSDOMWrapper>(exec, &JSSVGMissingGlyphElementConstructorTable, static_cast<JSSVGMissingGlyphElementConstructor*>(object), propertyName, descriptor);
}
...
bool JSSVGMissingGlyphElement::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSSVGMissingGlyphElement::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
