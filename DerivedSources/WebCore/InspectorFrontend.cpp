...
void InspectorFrontend::Database::sqlTransactionSucceeded(int transactionId, /*PassRefPtr<TypeBuilder::Array<String> >*/ PassRefPtr<InspectorArray> columnNames, /*PassRefPtr<TypeBuilder::Array<InspectorValue> >*/ PassRefPtr<InspectorArray> values)
{
...
void InspectorFrontend::IndexedDB::databaseNamesLoaded(double requestId, /*PassRefPtr<TypeBuilder::IndexedDB::SecurityOriginWithDatabaseNames>*/ PassRefPtr<InspectorObject> securityOriginWithDatabaseNames)
{
    RefPtr<InspectorObject> databaseNamesLoadedMessage = InspectorObject::create();
    databaseNamesLoadedMessage->setString("method", "IndexedDB.databaseNamesLoaded");
    RefPtr<InspectorObject> paramsObject = InspectorObject::create();
    paramsObject->setNumber("requestId", requestId);
    paramsObject->setObject("securityOriginWithDatabaseNames", securityOriginWithDatabaseNames);
    databaseNamesLoadedMessage->setObject("params", paramsObject);
    if (m_inspectorFrontendChannel)
        m_inspectorFrontendChannel->sendMessageToFrontend(databaseNamesLoadedMessage->toJSONString());
}

void InspectorFrontend::IndexedDB::databaseLoaded(int requestId, /*PassRefPtr<TypeBuilder::IndexedDB::DatabaseWithObjectStores>*/ PassRefPtr<InspectorObject> databaseWithObjectStores)
{
    RefPtr<InspectorObject> databaseLoadedMessage = InspectorObject::create();
    databaseLoadedMessage->setString("method", "IndexedDB.databaseLoaded");
    RefPtr<InspectorObject> paramsObject = InspectorObject::create();
    paramsObject->setNumber("requestId", requestId);
    paramsObject->setObject("databaseWithObjectStores", databaseWithObjectStores);
    databaseLoadedMessage->setObject("params", paramsObject);
    if (m_inspectorFrontendChannel)
        m_inspectorFrontendChannel->sendMessageToFrontend(databaseLoadedMessage->toJSONString());
}

void InspectorFrontend::IndexedDB::objectStoreDataLoaded(int requestId, /*PassRefPtr<TypeBuilder::Array<TypeBuilder::IndexedDB::DataEntry> >*/ PassRefPtr<InspectorArray> objectStoreDataEntries, bool hasMore)
{
    RefPtr<InspectorObject> objectStoreDataLoadedMessage = InspectorObject::create();
    objectStoreDataLoadedMessage->setString("method", "IndexedDB.objectStoreDataLoaded");
    RefPtr<InspectorObject> paramsObject = InspectorObject::create();
    paramsObject->setNumber("requestId", requestId);
    paramsObject->setArray("objectStoreDataEntries", objectStoreDataEntries);
    paramsObject->setBoolean("hasMore", hasMore);
    objectStoreDataLoadedMessage->setObject("params", paramsObject);
    if (m_inspectorFrontendChannel)
        m_inspectorFrontendChannel->sendMessageToFrontend(objectStoreDataLoadedMessage->toJSONString());
}

void InspectorFrontend::IndexedDB::indexDataLoaded(int requestId, /*PassRefPtr<TypeBuilder::Array<TypeBuilder::IndexedDB::DataEntry> >*/ PassRefPtr<InspectorArray> indexDataEntries, bool hasMore)
{
    RefPtr<InspectorObject> indexDataLoadedMessage = InspectorObject::create();
    indexDataLoadedMessage->setString("method", "IndexedDB.indexDataLoaded");
    RefPtr<InspectorObject> paramsObject = InspectorObject::create();
    paramsObject->setNumber("requestId", requestId);
    paramsObject->setArray("indexDataEntries", indexDataEntries);
    paramsObject->setBoolean("hasMore", hasMore);
    indexDataLoadedMessage->setObject("params", paramsObject);
    if (m_inspectorFrontendChannel)
        m_inspectorFrontendChannel->sendMessageToFrontend(indexDataLoadedMessage->toJSONString());
}
...
void InspectorFrontend::ApplicationCache::applicationCacheStatusUpdated(/*const TypeBuilder::Network::FrameId&*/ const String& frameId, const String& manifestURL, int status)
{
...
{
    RefPtr<InspectorObject> shadowRootPushedMessage = InspectorObject::create();
    shadowRootPushedMessage->setString("method", "DOM.shadowRootPushed");
    RefPtr<InspectorObject> paramsObject = InspectorObject::create();
    paramsObject->setNumber("hostId", hostId);
    paramsObject->setObject("root", root);
    shadowRootPushedMessage->setObject("params", paramsObject);
    if (m_inspectorFrontendChannel)
        m_inspectorFrontendChannel->sendMessageToFrontend(shadowRootPushedMessage->toJSONString());
}

void InspectorFrontend::DOM::shadowRootPopped(int hostId, int rootId)
{
    RefPtr<InspectorObject> shadowRootPoppedMessage = InspectorObject::create();
    shadowRootPoppedMessage->setString("method", "DOM.shadowRootPopped");
    RefPtr<InspectorObject> paramsObject = InspectorObject::create();
    paramsObject->setNumber("hostId", hostId);
    paramsObject->setNumber("rootId", rootId);
    shadowRootPoppedMessage->setObject("params", paramsObject);
    if (m_inspectorFrontendChannel)
        m_inspectorFrontendChannel->sendMessageToFrontend(shadowRootPoppedMessage->toJSONString());
}
...
{
    RefPtr<InspectorObject> styleSheetChangedMessage = InspectorObject::create();
    styleSheetChangedMessage->setString("method", "CSS.styleSheetChanged");
    RefPtr<InspectorObject> paramsObject = InspectorObject::create();
    paramsObject->setString("styleSheetId", styleSheetId);
    styleSheetChangedMessage->setObject("params", paramsObject);
    if (m_inspectorFrontendChannel)
        m_inspectorFrontendChannel->sendMessageToFrontend(styleSheetChangedMessage->toJSONString());
}
...
void InspectorFrontend::Debugger::scriptParsed(const TypeBuilder::Debugger::ScriptId& scriptId, const String& url, int startLine, int startColumn, int endLine, int endColumn, const bool* const isContentScript, const String* const sourceMapURL)
{
