...
bool JSSVGPointListConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSVGPointListConstructor, JSDOMWrapper>(exec, &JSSVGPointListConstructorTable, static_cast<JSSVGPointListConstructor*>(cell), propertyName, slot);
}

bool JSSVGPointListConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSVGPointListConstructor, JSDOMWrapper>(exec, &JSSVGPointListConstructorTable, static_cast<JSSVGPointListConstructor*>(object), propertyName, descriptor);
}
...
bool JSSVGPointListPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSSVGPointListPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSSVGPointList::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSSVGPointList* thisObject = jsCast<JSSVGPointList*>(cell);
...
bool JSSVGPointList::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
{
    JSSVGPointList* jsSVGPointList = static_cast<JSSVGPointList*>(handle.get().asCell());
