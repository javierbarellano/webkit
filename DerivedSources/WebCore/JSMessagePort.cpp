...
const ClassInfo JSMessagePortConstructor::s_info = { "MessagePortConstructor", &Base::s_info, &JSMessagePortConstructorTable, 0, CREATE_METHOD_TABLE(JSMessagePortConstructor) };
...
bool JSMessagePortConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSMessagePortConstructor, JSDOMWrapper>(exec, &JSMessagePortConstructorTable, static_cast<JSMessagePortConstructor*>(cell), propertyName, slot);
}

bool JSMessagePortConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSMessagePortConstructor, JSDOMWrapper>(exec, &JSMessagePortConstructorTable, static_cast<JSMessagePortConstructor*>(object), propertyName, descriptor);
}
...
bool JSMessagePortPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSMessagePortPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSMessagePort::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSMessagePort* thisObject = jsCast<JSMessagePort*>(cell);
...
bool JSMessagePort::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
void JSMessagePort::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
    JSMessagePort* thisObject = jsCast<JSMessagePort*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
