...
bool JSWebKitCSSTransformValueConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSWebKitCSSTransformValueConstructor, JSDOMWrapper>(exec, &JSWebKitCSSTransformValueConstructorTable, static_cast<JSWebKitCSSTransformValueConstructor*>(cell), propertyName, slot);
}

bool JSWebKitCSSTransformValueConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSWebKitCSSTransformValueConstructor, JSDOMWrapper>(exec, &JSWebKitCSSTransformValueConstructorTable, static_cast<JSWebKitCSSTransformValueConstructor*>(object), propertyName, descriptor);
}
...
bool JSWebKitCSSTransformValuePrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSWebKitCSSTransformValuePrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSWebKitCSSTransformValue::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    ...
    if (ok && index < static_cast<WebKitCSSTransformValue*>(thisObject->impl())->length()) {
...
bool JSWebKitCSSTransformValue::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSWebKitCSSTransformValue::getOwnPropertySlotByIndex(JSCell* cell, ExecState* exec, unsigned propertyName, PropertySlot& slot)
{
    JSWebKitCSSTransformValue* thisObject = jsCast<JSWebKitCSSTransformValue*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
    if (propertyName < static_cast<WebKitCSSTransformValue*>(thisObject->impl())->length()) {
