...
public:
    ...
    {
        JSMediaStream* ptr = new (NotNull, JSC::allocateCell<JSMediaStream>(globalObject->globalData().heap)) JSMediaStream(structure, globalObject, impl);
...
public:
    ...
    {
        JSMediaStreamPrototype* ptr = new (NotNull, JSC::allocateCell<JSMediaStreamPrototype>(globalData.heap)) JSMediaStreamPrototype(globalData, globalObject, structure);
...
public:
    ...
    {
        JSMediaStreamConstructor* ptr = new (NotNull, JSC::allocateCell<JSMediaStreamConstructor>(*exec->heap())) JSMediaStreamConstructor(structure, globalObject);
...
JSC::JSValue jsMediaStreamAudioTracks(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsMediaStreamVideoTracks(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
