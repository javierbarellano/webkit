...
static const HashTableValue JSElementTableValues[] =
{
    ...
    { "webkitRegionOverflow", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsElementWebkitRegionOverflow), (intptr_t)0, NoIntrinsic },
...
static const HashTable JSElementTable = { 264, 255, JSElementTableValues, 0 };
...
bool JSElementConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSElementConstructor, JSDOMWrapper>(exec, &JSElementConstructorTable, static_cast<JSElementConstructor*>(cell), propertyName, slot);
}

bool JSElementConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSElementConstructor, JSDOMWrapper>(exec, &JSElementConstructorTable, static_cast<JSElementConstructor*>(object), propertyName, descriptor);
}
...
static const HashTable JSElementPrototypeTable = { 72, 63, JSElementPrototypeTableValues, 0 };
...
bool JSElementPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSElementPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
JSValue jsElementWebkitRegionOverflow(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSElement* castedThis = static_cast<JSElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    Element* impl = static_cast<Element*>(castedThis->impl());
    JSValue result = jsString(exec, impl->webkitRegionOverflow());
    return result;
}
...
#if ENABLE(FULLSCREEN_API)
JSValue jsElementOnwebkitfullscreenerror(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSElement* castedThis = static_cast<JSElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    Element* impl = static_cast<Element*>(castedThis->impl());
...
void JSElement::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
...
EncodedJSValue JSC_HOST_CALL jsElementPrototypeFunctionGetAttributeNS(ExecState* exec)
{
    ...
    JSC::JSValue result = jsString(exec, impl->getAttributeNS(namespaceURI, localName));
    return JSValue::encode(result);
}
...
EncodedJSValue JSC_HOST_CALL jsElementPrototypeFunctionSetAttributeNS(ExecState* exec)
{
    ...
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    const String& qualifiedName(ustringToString(MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    const String& value(ustringToString(MAYBE_MISSING_PARAMETER(exec, 2, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 2, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
...
JSValue jsElementALLOW_KEYBOARD_INPUT(ExecState* exec, JSValue, const Identifier&)
{
    UNUSED_PARAM(exec);
