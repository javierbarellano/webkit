...
ASSERT_CLASS_FITS_IN_CELL(JSMutationRecord);
/* Hash table */
...
void JSMutationRecordConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
    ...
    putDirect(exec->globalData(), exec->propertyNames().prototype, JSMutationRecordPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}

bool JSMutationRecordConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSMutationRecordConstructor, JSDOMWrapper>(exec, &JSMutationRecordConstructorTable, static_cast<JSMutationRecordConstructor*>(cell), propertyName, slot);
}

bool JSMutationRecordConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSMutationRecordConstructor, JSDOMWrapper>(exec, &JSMutationRecordConstructorTable, static_cast<JSMutationRecordConstructor*>(object), propertyName, descriptor);
}
...
void JSMutationRecord::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSMutationRecordPrototype::create(exec->globalData(), globalObject, JSMutationRecordPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
...
bool JSMutationRecord::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSMutationRecord* thisObject = jsCast<JSMutationRecord*>(cell);
...
bool JSMutationRecord::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
JSValue jsMutationRecordType(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSMutationRecord* castedThis = static_cast<JSMutationRecord*>(asObject(slotBase));
    UNUSED_PARAM(exec);
...
JSValue jsMutationRecordTarget(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSMutationRecord* castedThis = static_cast<JSMutationRecord*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    MutationRecord* impl = static_cast<MutationRecord*>(castedThis->impl());
...
JSValue jsMutationRecordAddedNodes(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSMutationRecord* castedThis = static_cast<JSMutationRecord*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    MutationRecord* impl = static_cast<MutationRecord*>(castedThis->impl());
...
JSValue jsMutationRecordRemovedNodes(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSMutationRecord* castedThis = static_cast<JSMutationRecord*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    MutationRecord* impl = static_cast<MutationRecord*>(castedThis->impl());
...
JSValue jsMutationRecordPreviousSibling(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSMutationRecord* castedThis = static_cast<JSMutationRecord*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    MutationRecord* impl = static_cast<MutationRecord*>(castedThis->impl());
...
JSValue jsMutationRecordNextSibling(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSMutationRecord* castedThis = static_cast<JSMutationRecord*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    MutationRecord* impl = static_cast<MutationRecord*>(castedThis->impl());
...
JSValue jsMutationRecordAttributeName(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSMutationRecord* castedThis = static_cast<JSMutationRecord*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    MutationRecord* impl = static_cast<MutationRecord*>(castedThis->impl());
    JSValue result = jsString(exec, impl->attributeName());
    return result;
}


JSValue jsMutationRecordAttributeNamespace(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSMutationRecord* castedThis = static_cast<JSMutationRecord*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    MutationRecord* impl = static_cast<MutationRecord*>(castedThis->impl());
...
JSValue jsMutationRecordOldValue(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSMutationRecord* castedThis = static_cast<JSMutationRecord*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    MutationRecord* impl = static_cast<MutationRecord*>(castedThis->impl());
...
JSValue jsMutationRecordConstructor(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSMutationRecord* domObject = static_cast<JSMutationRecord*>(asObject(slotBase));
...
{
    return getDOMConstructor<JSMutationRecordConstructor>(exec, static_cast<JSDOMGlobalObject*>(globalObject));
}
...
{
    JSMutationRecord* jsMutationRecord = static_cast<JSMutationRecord*>(handle.get().asCell());
...
{
    return wrap<JSMutationRecord>(exec, globalObject, impl);
}

MutationRecord* toMutationRecord(JSC::JSValue value)
{
    return value.inherits(&JSMutationRecord::s_info) ? static_cast<JSMutationRecord*>(asObject(value))->impl() : 0;
}
