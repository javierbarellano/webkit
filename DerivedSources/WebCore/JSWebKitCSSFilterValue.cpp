...
ASSERT_CLASS_FITS_IN_CELL(JSWebKitCSSFilterValue);
/* Hash table */
...
bool JSWebKitCSSFilterValueConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSWebKitCSSFilterValueConstructor, JSDOMWrapper>(exec, &JSWebKitCSSFilterValueConstructorTable, static_cast<JSWebKitCSSFilterValueConstructor*>(cell), propertyName, slot);
}

bool JSWebKitCSSFilterValueConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSWebKitCSSFilterValueConstructor, JSDOMWrapper>(exec, &JSWebKitCSSFilterValueConstructorTable, static_cast<JSWebKitCSSFilterValueConstructor*>(object), propertyName, descriptor);
}
...
bool JSWebKitCSSFilterValuePrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSWebKitCSSFilterValuePrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSWebKitCSSFilterValue::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    ...
    if (ok && index < static_cast<WebKitCSSFilterValue*>(thisObject->impl())->length()) {
...
bool JSWebKitCSSFilterValue::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSWebKitCSSFilterValue::getOwnPropertySlotByIndex(JSCell* cell, ExecState* exec, unsigned propertyName, PropertySlot& slot)
{
    JSWebKitCSSFilterValue* thisObject = jsCast<JSWebKitCSSFilterValue*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
    if (propertyName < static_cast<WebKitCSSFilterValue*>(thisObject->impl())->length()) {
...
JSValue jsWebKitCSSFilterValueOperationType(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSWebKitCSSFilterValue* castedThis = static_cast<JSWebKitCSSFilterValue*>(asObject(slotBase));
    UNUSED_PARAM(exec);
...
JSValue jsWebKitCSSFilterValueConstructor(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSWebKitCSSFilterValue* domObject = static_cast<JSWebKitCSSFilterValue*>(asObject(slotBase));
...
{
    return getDOMConstructor<JSWebKitCSSFilterValueConstructor>(exec, static_cast<JSDOMGlobalObject*>(globalObject));
}

// Constant getters

JSValue jsWebKitCSSFilterValueCSS_FILTER_REFERENCE(ExecState* exec, JSValue, const Identifier&)
{
    UNUSED_PARAM(exec);
    return jsNumber(static_cast<int>(1));
}

JSValue jsWebKitCSSFilterValueCSS_FILTER_GRAYSCALE(ExecState* exec, JSValue, const Identifier&)
{
    UNUSED_PARAM(exec);
    return jsNumber(static_cast<int>(2));
}

JSValue jsWebKitCSSFilterValueCSS_FILTER_SEPIA(ExecState* exec, JSValue, const Identifier&)
{
    UNUSED_PARAM(exec);
    return jsNumber(static_cast<int>(3));
}

JSValue jsWebKitCSSFilterValueCSS_FILTER_SATURATE(ExecState* exec, JSValue, const Identifier&)
{
    UNUSED_PARAM(exec);
    return jsNumber(static_cast<int>(4));
}

JSValue jsWebKitCSSFilterValueCSS_FILTER_HUE_ROTATE(ExecState* exec, JSValue, const Identifier&)
{
    UNUSED_PARAM(exec);
    return jsNumber(static_cast<int>(5));
}

JSValue jsWebKitCSSFilterValueCSS_FILTER_INVERT(ExecState* exec, JSValue, const Identifier&)
{
    UNUSED_PARAM(exec);
    return jsNumber(static_cast<int>(6));
}

JSValue jsWebKitCSSFilterValueCSS_FILTER_OPACITY(ExecState* exec, JSValue, const Identifier&)
{
    UNUSED_PARAM(exec);
    return jsNumber(static_cast<int>(7));
}

JSValue jsWebKitCSSFilterValueCSS_FILTER_BRIGHTNESS(ExecState* exec, JSValue, const Identifier&)
{
    UNUSED_PARAM(exec);
    return jsNumber(static_cast<int>(8));
}

JSValue jsWebKitCSSFilterValueCSS_FILTER_CONTRAST(ExecState* exec, JSValue, const Identifier&)
{
    UNUSED_PARAM(exec);
    return jsNumber(static_cast<int>(9));
}

JSValue jsWebKitCSSFilterValueCSS_FILTER_BLUR(ExecState* exec, JSValue, const Identifier&)
{
    UNUSED_PARAM(exec);
    return jsNumber(static_cast<int>(10));
}

JSValue jsWebKitCSSFilterValueCSS_FILTER_DROP_SHADOW(ExecState* exec, JSValue, const Identifier&)
{
    UNUSED_PARAM(exec);
...
{
    JSWebKitCSSFilterValue* thisObj = static_cast<JSWebKitCSSFilterValue*>(asObject(slotBase));
