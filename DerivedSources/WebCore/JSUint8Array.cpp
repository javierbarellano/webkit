...
{
    return getStaticValueSlot<JSUint8ArrayConstructor, JSDOMWrapper>(exec, &JSUint8ArrayConstructorTable, static_cast<JSUint8ArrayConstructor*>(cell), propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSUint8ArrayConstructor, JSDOMWrapper>(exec, &JSUint8ArrayConstructorTable, static_cast<JSUint8ArrayConstructor*>(object), propertyName, descriptor);
}
