...
bool JSHTMLSpanElementConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSHTMLSpanElementConstructor, JSDOMWrapper>(exec, &JSHTMLSpanElementConstructorTable, static_cast<JSHTMLSpanElementConstructor*>(cell), propertyName, slot);
}

bool JSHTMLSpanElementConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSHTMLSpanElementConstructor, JSDOMWrapper>(exec, &JSHTMLSpanElementConstructorTable, static_cast<JSHTMLSpanElementConstructor*>(object), propertyName, descriptor);
}
...
bool JSHTMLSpanElement::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSHTMLSpanElement::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
