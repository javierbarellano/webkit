...
JSC::JSValue jsHTMLFieldSetElementDisabled(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
...
JSC::JSValue jsHTMLFieldSetElementName(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSHTMLFieldSetElementName(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsHTMLFieldSetElementType(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
