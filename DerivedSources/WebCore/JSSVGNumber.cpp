...
bool JSSVGNumberConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSVGNumberConstructor, JSDOMWrapper>(exec, &JSSVGNumberConstructorTable, static_cast<JSSVGNumberConstructor*>(cell), propertyName, slot);
}

bool JSSVGNumberConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSVGNumberConstructor, JSDOMWrapper>(exec, &JSSVGNumberConstructorTable, static_cast<JSSVGNumberConstructor*>(object), propertyName, descriptor);
}
...
bool JSSVGNumber::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSSVGNumber* thisObject = jsCast<JSSVGNumber*>(cell);
...
bool JSSVGNumber::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
void JSSVGNumber::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
    JSSVGNumber* thisObject = jsCast<JSSVGNumber*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
...
{
    JSSVGNumber* jsSVGNumber = static_cast<JSSVGNumber*>(handle.get().asCell());
