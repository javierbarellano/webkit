...
bool JSSQLResultSetRowListPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSSQLResultSetRowListPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSSQLResultSetRowList::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSSQLResultSetRowList* thisObject = jsCast<JSSQLResultSetRowList*>(cell);
...
bool JSSQLResultSetRowList::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
{
    JSSQLResultSetRowList* jsSQLResultSetRowList = static_cast<JSSQLResultSetRowList*>(handle.get().asCell());
