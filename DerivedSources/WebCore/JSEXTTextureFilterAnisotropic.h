...
JSC::JSValue jsEXTTextureFilterAnisotropicTEXTURE_MAX_ANISOTROPY_EXT(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsEXTTextureFilterAnisotropicMAX_TEXTURE_MAX_ANISOTROPY_EXT(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
