...
bool JSCSSPrimitiveValueConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSCSSPrimitiveValueConstructor, JSDOMWrapper>(exec, &JSCSSPrimitiveValueConstructorTable, static_cast<JSCSSPrimitiveValueConstructor*>(cell), propertyName, slot);
}

bool JSCSSPrimitiveValueConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSCSSPrimitiveValueConstructor, JSDOMWrapper>(exec, &JSCSSPrimitiveValueConstructorTable, static_cast<JSCSSPrimitiveValueConstructor*>(object), propertyName, descriptor);
}
...
bool JSCSSPrimitiveValuePrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSCSSPrimitiveValuePrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSCSSPrimitiveValue::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSCSSPrimitiveValue::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
EncodedJSValue JSC_HOST_CALL jsCSSPrimitiveValuePrototypeFunctionSetStringValue(ExecState* exec)
{
    ...
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    const String& stringValue(ustringToString(MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
...
EncodedJSValue JSC_HOST_CALL jsCSSPrimitiveValuePrototypeFunctionGetStringValue(ExecState* exec)
{
    ...
    JSC::JSValue result = jsString(exec, impl->getStringValue(ec));
    setDOMException(exec, ec);
    return JSValue::encode(result);
}
...
JSValue jsCSSPrimitiveValueCSS_VW(ExecState* exec, JSValue, const Identifier&)
{
    UNUSED_PARAM(exec);
    return jsNumber(static_cast<int>(26));
}

JSValue jsCSSPrimitiveValueCSS_VH(ExecState* exec, JSValue, const Identifier&)
{
    UNUSED_PARAM(exec);
    return jsNumber(static_cast<int>(27));
}

JSValue jsCSSPrimitiveValueCSS_VMIN(ExecState* exec, JSValue, const Identifier&)
{
    UNUSED_PARAM(exec);
