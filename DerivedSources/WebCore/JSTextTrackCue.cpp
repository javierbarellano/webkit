...
void JSTextTrackCueConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
    ...
    putDirect(exec->globalData(), exec->propertyNames().prototype, JSTextTrackCuePrototype::self(exec, globalObject), DontDelete | ReadOnly);
    putDirect(exec->globalData(), exec->propertyNames().length, jsNumber(6), ReadOnly | DontDelete | DontEnum);
}

bool JSTextTrackCueConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSTextTrackCueConstructor, JSDOMWrapper>(exec, &JSTextTrackCueConstructorTable, static_cast<JSTextTrackCueConstructor*>(cell), propertyName, slot);
}

bool JSTextTrackCueConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSTextTrackCueConstructor, JSDOMWrapper>(exec, &JSTextTrackCueConstructorTable, static_cast<JSTextTrackCueConstructor*>(object), propertyName, descriptor);
}

EncodedJSValue JSC_HOST_CALL JSTextTrackCueConstructor::constructJSTextTrackCue(ExecState* exec)
{
    JSTextTrackCueConstructor* castedThis = static_cast<JSTextTrackCueConstructor*>(exec->callee());
    if (exec->argumentCount() < 4)
        return throwVMError(exec, createTypeError(exec, "Not enough arguments"));
    const String& id(ustringToString(MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    double startTime(MAYBE_MISSING_PARAMETER(exec, 1, DefaultIsUndefined).toNumber(exec));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    double endTime(MAYBE_MISSING_PARAMETER(exec, 2, DefaultIsUndefined).toNumber(exec));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    const String& text(ustringToString(MAYBE_MISSING_PARAMETER(exec, 3, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 3, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    const String& settings(ustringToString(MAYBE_MISSING_PARAMETER(exec, 4, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 4, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    bool pauseOnExit(MAYBE_MISSING_PARAMETER(exec, 5, DefaultIsUndefined).toBoolean(exec));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    ...
    RefPtr<TextTrackCue> object = TextTrackCue::create(context, id, startTime, endTime, text, settings, pauseOnExit);
...
static const HashTableValue JSTextTrackCuePrototypeTableValues[] =
{
    ...
    { "addEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsTextTrackCuePrototypeFunctionAddEventListener), (intptr_t)3, NoIntrinsic },
    { "removeEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsTextTrackCuePrototypeFunctionRemoveEventListener), (intptr_t)3, NoIntrinsic },
...
bool JSTextTrackCuePrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSTextTrackCuePrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
void JSTextTrackCue::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSTextTrackCuePrototype::create(exec->globalData(), globalObject, JSTextTrackCuePrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
...
bool JSTextTrackCue::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSTextTrackCue* thisObject = jsCast<JSTextTrackCue*>(cell);
...
bool JSTextTrackCue::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
JSValue jsTextTrackCueTrack(ExecState* exec, JSValue slotBase, const Identifier&)
{
...
JSValue jsTextTrackCueId(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    TextTrackCue* impl = static_cast<TextTrackCue*>(castedThis->impl());
    JSValue result = jsString(exec, impl->id());
    return result;
}
...
JSValue jsTextTrackCueVertical(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    TextTrackCue* impl = static_cast<TextTrackCue*>(castedThis->impl());
    JSValue result = jsString(exec, impl->vertical());
    return result;
}
...
JSValue jsTextTrackCueAlign(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    TextTrackCue* impl = static_cast<TextTrackCue*>(castedThis->impl());
    JSValue result = jsString(exec, impl->align());
    return result;
}
...
void JSTextTrackCue::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
    JSTextTrackCue* thisObject = jsCast<JSTextTrackCue*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
...
void setJSTextTrackCueId(ExecState* exec, JSObject* thisObject, JSValue value)
{
    ...
    TextTrackCue* impl = static_cast<TextTrackCue*>(castedThis->impl());
    impl->setId(ustringToString(value.isEmpty() ? UString() : value.toString(exec)->value(exec)));
}
...
void setJSTextTrackCueStartTime(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSTextTrackCue* castedThis = static_cast<JSTextTrackCue*>(thisObject);
    TextTrackCue* impl = static_cast<TextTrackCue*>(castedThis->impl());
    impl->setStartTime(value.toNumber(exec));
}
...
void setJSTextTrackCueEndTime(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSTextTrackCue* castedThis = static_cast<JSTextTrackCue*>(thisObject);
    TextTrackCue* impl = static_cast<TextTrackCue*>(castedThis->impl());
    impl->setEndTime(value.toNumber(exec));
}
...
void setJSTextTrackCuePauseOnExit(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSTextTrackCue* castedThis = static_cast<JSTextTrackCue*>(thisObject);
    TextTrackCue* impl = static_cast<TextTrackCue*>(castedThis->impl());
    impl->setPauseOnExit(value.toBoolean(exec));
}
...
void setJSTextTrackCueVertical(ExecState* exec, JSObject* thisObject, JSValue value)
{
    ...
    TextTrackCue* impl = static_cast<TextTrackCue*>(castedThis->impl());
    ExceptionCode ec = 0;
    impl->setVertical(ustringToString(value.isEmpty() ? UString() : value.toString(exec)->value(exec)), ec);
...
void setJSTextTrackCueSnapToLines(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSTextTrackCue* castedThis = static_cast<JSTextTrackCue*>(thisObject);
    TextTrackCue* impl = static_cast<TextTrackCue*>(castedThis->impl());
    impl->setSnapToLines(value.toBoolean(exec));
}
...
void setJSTextTrackCueLine(ExecState* exec, JSObject* thisObject, JSValue value)
{
    ...
    TextTrackCue* impl = static_cast<TextTrackCue*>(castedThis->impl());
    ExceptionCode ec = 0;
    impl->setLine(value.toInt32(exec), ec);
    setDOMException(exec, ec);
}
...
void setJSTextTrackCuePosition(ExecState* exec, JSObject* thisObject, JSValue value)
{
    ...
    TextTrackCue* impl = static_cast<TextTrackCue*>(castedThis->impl());
    ExceptionCode ec = 0;
    impl->setPosition(value.toInt32(exec), ec);
    setDOMException(exec, ec);
}
...
void setJSTextTrackCueSize(ExecState* exec, JSObject* thisObject, JSValue value)
{
    ...
    TextTrackCue* impl = static_cast<TextTrackCue*>(castedThis->impl());
    ExceptionCode ec = 0;
    impl->setSize(value.toInt32(exec), ec);
    setDOMException(exec, ec);
}
...
void setJSTextTrackCueAlign(ExecState* exec, JSObject* thisObject, JSValue value)
{
    ...
    TextTrackCue* impl = static_cast<TextTrackCue*>(castedThis->impl());
    ExceptionCode ec = 0;
    impl->setAlign(ustringToString(value.isEmpty() ? UString() : value.toString(exec)->value(exec)), ec);
    setDOMException(exec, ec);
}
...
void setJSTextTrackCueText(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSTextTrackCue* castedThis = static_cast<JSTextTrackCue*>(thisObject);
    TextTrackCue* impl = static_cast<TextTrackCue*>(castedThis->impl());
    impl->setText(ustringToString(value.isEmpty() ? UString() : value.toString(exec)->value(exec)));
}
...
{
    return wrap<JSTextTrackCue>(exec, globalObject, impl);
}
