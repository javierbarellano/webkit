...
bool JSWebKitCSSKeyframesRuleConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSWebKitCSSKeyframesRuleConstructor, JSDOMWrapper>(exec, &JSWebKitCSSKeyframesRuleConstructorTable, static_cast<JSWebKitCSSKeyframesRuleConstructor*>(cell), propertyName, slot);
}

bool JSWebKitCSSKeyframesRuleConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSWebKitCSSKeyframesRuleConstructor, JSDOMWrapper>(exec, &JSWebKitCSSKeyframesRuleConstructorTable, static_cast<JSWebKitCSSKeyframesRuleConstructor*>(object), propertyName, descriptor);
}
...
bool JSWebKitCSSKeyframesRulePrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSWebKitCSSKeyframesRulePrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSWebKitCSSKeyframesRule::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    ...
    if (ok && index < static_cast<WebKitCSSKeyframesRule*>(thisObject->impl())->length()) {
...
bool JSWebKitCSSKeyframesRule::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSWebKitCSSKeyframesRule::getOwnPropertySlotByIndex(JSCell* cell, ExecState* exec, unsigned propertyName, PropertySlot& slot)
{
    JSWebKitCSSKeyframesRule* thisObject = jsCast<JSWebKitCSSKeyframesRule*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
    if (propertyName < static_cast<WebKitCSSKeyframesRule*>(thisObject->impl())->length()) {
...
void JSWebKitCSSKeyframesRule::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
    JSWebKitCSSKeyframesRule* thisObject = jsCast<JSWebKitCSSKeyframesRule*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
