...
static const HashTable JSHTMLFieldSetElementTable = { 18, 15, JSHTMLFieldSetElementTableValues, 0 };
...
bool JSHTMLFieldSetElementConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSHTMLFieldSetElementConstructor, JSDOMWrapper>(exec, &JSHTMLFieldSetElementConstructorTable, static_cast<JSHTMLFieldSetElementConstructor*>(cell), propertyName, slot);
}

bool JSHTMLFieldSetElementConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSHTMLFieldSetElementConstructor, JSDOMWrapper>(exec, &JSHTMLFieldSetElementConstructorTable, static_cast<JSHTMLFieldSetElementConstructor*>(object), propertyName, descriptor);
}
...
bool JSHTMLFieldSetElementPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSHTMLFieldSetElementPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSHTMLFieldSetElement::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSHTMLFieldSetElement::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
JSValue jsHTMLFieldSetElementDisabled(ExecState* exec, JSValue slotBase, const Identifier&)
{
...
JSValue jsHTMLFieldSetElementName(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSHTMLFieldSetElement* castedThis = static_cast<JSHTMLFieldSetElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    HTMLFieldSetElement* impl = static_cast<HTMLFieldSetElement*>(castedThis->impl());
...
JSValue jsHTMLFieldSetElementType(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSHTMLFieldSetElement* castedThis = static_cast<JSHTMLFieldSetElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    HTMLFieldSetElement* impl = static_cast<HTMLFieldSetElement*>(castedThis->impl());
...
void JSHTMLFieldSetElement::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
    JSHTMLFieldSetElement* thisObject = jsCast<JSHTMLFieldSetElement*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
...
{
    JSHTMLFieldSetElement* castedThis = static_cast<JSHTMLFieldSetElement*>(thisObject);
    HTMLFieldSetElement* impl = static_cast<HTMLFieldSetElement*>(castedThis->impl());
