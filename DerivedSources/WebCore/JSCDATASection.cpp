...
bool JSCDATASectionConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSCDATASectionConstructor, JSDOMWrapper>(exec, &JSCDATASectionConstructorTable, static_cast<JSCDATASectionConstructor*>(cell), propertyName, slot);
}

bool JSCDATASectionConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSCDATASectionConstructor, JSDOMWrapper>(exec, &JSCDATASectionConstructorTable, static_cast<JSCDATASectionConstructor*>(object), propertyName, descriptor);
}
...
bool JSCDATASection::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSCDATASection::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
