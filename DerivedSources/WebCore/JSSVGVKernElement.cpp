...
bool JSSVGVKernElementConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSVGVKernElementConstructor, JSDOMWrapper>(exec, &JSSVGVKernElementConstructorTable, static_cast<JSSVGVKernElementConstructor*>(cell), propertyName, slot);
}

bool JSSVGVKernElementConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSVGVKernElementConstructor, JSDOMWrapper>(exec, &JSSVGVKernElementConstructorTable, static_cast<JSSVGVKernElementConstructor*>(object), propertyName, descriptor);
}
...
bool JSSVGVKernElement::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSSVGVKernElement::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
