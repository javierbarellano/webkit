...
bool JSRangeConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSRangeConstructor, JSDOMWrapper>(exec, &JSRangeConstructorTable, static_cast<JSRangeConstructor*>(cell), propertyName, slot);
}

bool JSRangeConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSRangeConstructor, JSDOMWrapper>(exec, &JSRangeConstructorTable, static_cast<JSRangeConstructor*>(object), propertyName, descriptor);
}
...
bool JSRangePrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSRangePrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSRange::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSRange* thisObject = jsCast<JSRange*>(cell);
...
bool JSRange::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
EncodedJSValue JSC_HOST_CALL jsRangePrototypeFunctionToString(ExecState* exec)
{
    ...
    JSC::JSValue result = jsString(exec, impl->toString(ec));
    setDOMException(exec, ec);
    return JSValue::encode(result);
}
...
EncodedJSValue JSC_HOST_CALL jsRangePrototypeFunctionCreateContextualFragment(ExecState* exec)
{
    ...
    Range* impl = static_cast<Range*>(castedThis->impl());
    ExceptionCode ec = 0;
    const String& html(ustringToString(MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
...
EncodedJSValue JSC_HOST_CALL jsRangePrototypeFunctionExpand(ExecState* exec)
{
    ...
    Range* impl = static_cast<Range*>(castedThis->impl());
    ExceptionCode ec = 0;
    const String& unit(ustringToString(MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).isEmpty() ? UString() : MAYBE_MISSING_PARAMETER(exec, 0, DefaultIsUndefined).toString(exec)->value(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    impl->expand(unit, ec);
    setDOMException(exec, ec);
...
{
    JSRange* jsRange = static_cast<JSRange*>(handle.get().asCell());
