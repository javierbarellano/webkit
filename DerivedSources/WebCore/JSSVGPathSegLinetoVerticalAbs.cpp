...
bool JSSVGPathSegLinetoVerticalAbsConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSVGPathSegLinetoVerticalAbsConstructor, JSDOMWrapper>(exec, &JSSVGPathSegLinetoVerticalAbsConstructorTable, static_cast<JSSVGPathSegLinetoVerticalAbsConstructor*>(cell), propertyName, slot);
}

bool JSSVGPathSegLinetoVerticalAbsConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSVGPathSegLinetoVerticalAbsConstructor, JSDOMWrapper>(exec, &JSSVGPathSegLinetoVerticalAbsConstructorTable, static_cast<JSSVGPathSegLinetoVerticalAbsConstructor*>(object), propertyName, descriptor);
}
...
bool JSSVGPathSegLinetoVerticalAbs::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSSVGPathSegLinetoVerticalAbs::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
void JSSVGPathSegLinetoVerticalAbs::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
    JSSVGPathSegLinetoVerticalAbs* thisObject = jsCast<JSSVGPathSegLinetoVerticalAbs*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
