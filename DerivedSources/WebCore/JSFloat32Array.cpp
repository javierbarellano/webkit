...
{
    return getStaticValueSlot<JSFloat32ArrayConstructor, JSDOMWrapper>(exec, &JSFloat32ArrayConstructorTable, static_cast<JSFloat32ArrayConstructor*>(cell), propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSFloat32ArrayConstructor, JSDOMWrapper>(exec, &JSFloat32ArrayConstructorTable, static_cast<JSFloat32ArrayConstructor*>(object), propertyName, descriptor);
}
