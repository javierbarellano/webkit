...
const ClassInfo JSEventExceptionConstructor::s_info = { "EventExceptionConstructor", &Base::s_info, &JSEventExceptionConstructorTable, 0, CREATE_METHOD_TABLE(JSEventExceptionConstructor) };
...
bool JSEventExceptionConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSEventExceptionConstructor, JSDOMWrapper>(exec, &JSEventExceptionConstructorTable, static_cast<JSEventExceptionConstructor*>(cell), propertyName, slot);
}

bool JSEventExceptionConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSEventExceptionConstructor, JSDOMWrapper>(exec, &JSEventExceptionConstructorTable, static_cast<JSEventExceptionConstructor*>(object), propertyName, descriptor);
}
...
bool JSEventExceptionPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSEventExceptionPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSEventException::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSEventException* thisObject = jsCast<JSEventException*>(cell);
...
bool JSEventException::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
{
    JSEventException* jsEventException = static_cast<JSEventException*>(handle.get().asCell());
