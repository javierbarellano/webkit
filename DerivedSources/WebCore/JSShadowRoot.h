...
JSC::JSValue jsShadowRootHost(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsShadowRootActiveElement(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsShadowRootInnerHTML(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSShadowRootInnerHTML(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsShadowRootConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
