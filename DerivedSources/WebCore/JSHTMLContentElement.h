...
JSC::JSValue jsHTMLContentElementSelect(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSHTMLContentElementSelect(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsHTMLContentElementConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
