...
void JSTextTrackCueListConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
    ...
    putDirect(exec->globalData(), exec->propertyNames().prototype, JSTextTrackCueListPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}

bool JSTextTrackCueListConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSTextTrackCueListConstructor, JSDOMWrapper>(exec, &JSTextTrackCueListConstructorTable, static_cast<JSTextTrackCueListConstructor*>(cell), propertyName, slot);
}

bool JSTextTrackCueListConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSTextTrackCueListConstructor, JSDOMWrapper>(exec, &JSTextTrackCueListConstructorTable, static_cast<JSTextTrackCueListConstructor*>(object), propertyName, descriptor);
}
...
bool JSTextTrackCueListPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSTextTrackCueListPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
void JSTextTrackCueList::finishCreation(JSGlobalData& globalData)
{
...
{
    return JSTextTrackCueListPrototype::create(exec->globalData(), globalObject, JSTextTrackCueListPrototype::createStructure(globalObject->globalData(), globalObject, globalObject->objectPrototype()));
}
...
bool JSTextTrackCueList::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSTextTrackCueList* thisObject = jsCast<JSTextTrackCueList*>(cell);
    ...
    if (ok && index < static_cast<TextTrackCueList*>(thisObject->impl())->length()) {
...
bool JSTextTrackCueList::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSTextTrackCueList::getOwnPropertySlotByIndex(JSCell* cell, ExecState* exec, unsigned propertyName, PropertySlot& slot)
{
    JSTextTrackCueList* thisObject = jsCast<JSTextTrackCueList*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
    if (propertyName < static_cast<TextTrackCueList*>(thisObject->impl())->length()) {
...
{
    JSTextTrackCueList* jsTextTrackCueList = static_cast<JSTextTrackCueList*>(handle.get().asCell());
...
{
    return wrap<JSTextTrackCueList>(exec, globalObject, impl);
}
