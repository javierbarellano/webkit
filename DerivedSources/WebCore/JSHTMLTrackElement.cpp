...
bool JSHTMLTrackElementConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSHTMLTrackElementConstructor, JSDOMWrapper>(exec, &JSHTMLTrackElementConstructorTable, static_cast<JSHTMLTrackElementConstructor*>(cell), propertyName, slot);
}

bool JSHTMLTrackElementConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSHTMLTrackElementConstructor, JSDOMWrapper>(exec, &JSHTMLTrackElementConstructorTable, static_cast<JSHTMLTrackElementConstructor*>(object), propertyName, descriptor);
}
...
bool JSHTMLTrackElementPrototype::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSHTMLTrackElementPrototype::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
bool JSHTMLTrackElement::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSHTMLTrackElement::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
JSValue jsHTMLTrackElementSrclang(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    HTMLTrackElement* impl = static_cast<HTMLTrackElement*>(castedThis->impl());
    JSValue result = jsString(exec, impl->srclang());
    return result;
}
...
JSValue jsHTMLTrackElementReadyState(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSHTMLTrackElement* castedThis = static_cast<JSHTMLTrackElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    HTMLTrackElement* impl = static_cast<HTMLTrackElement*>(castedThis->impl());
...
JSValue jsHTMLTrackElementTrack(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSHTMLTrackElement* castedThis = static_cast<JSHTMLTrackElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    HTMLTrackElement* impl = static_cast<HTMLTrackElement*>(castedThis->impl());
...
void JSHTMLTrackElement::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
    JSHTMLTrackElement* thisObject = jsCast<JSHTMLTrackElement*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
...
void setJSHTMLTrackElementKind(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSHTMLTrackElement* castedThis = static_cast<JSHTMLTrackElement*>(thisObject);
    HTMLTrackElement* impl = static_cast<HTMLTrackElement*>(castedThis->impl());
    impl->setKind(ustringToString(value.isEmpty() ? UString() : value.toString(exec)->value(exec)));
}
...
void setJSHTMLTrackElementSrclang(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSHTMLTrackElement* castedThis = static_cast<JSHTMLTrackElement*>(thisObject);
    HTMLTrackElement* impl = static_cast<HTMLTrackElement*>(castedThis->impl());
    impl->setSrclang(ustringToString(value.isEmpty() ? UString() : value.toString(exec)->value(exec)));
}
