...
bool JSSVGAnimatedPreserveAspectRatioConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSSVGAnimatedPreserveAspectRatioConstructor, JSDOMWrapper>(exec, &JSSVGAnimatedPreserveAspectRatioConstructorTable, static_cast<JSSVGAnimatedPreserveAspectRatioConstructor*>(cell), propertyName, slot);
}

bool JSSVGAnimatedPreserveAspectRatioConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSSVGAnimatedPreserveAspectRatioConstructor, JSDOMWrapper>(exec, &JSSVGAnimatedPreserveAspectRatioConstructorTable, static_cast<JSSVGAnimatedPreserveAspectRatioConstructor*>(object), propertyName, descriptor);
}
...
bool JSSVGAnimatedPreserveAspectRatio::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    JSSVGAnimatedPreserveAspectRatio* thisObject = jsCast<JSSVGAnimatedPreserveAspectRatio*>(cell);
...
bool JSSVGAnimatedPreserveAspectRatio::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
{
    JSSVGAnimatedPreserveAspectRatio* jsSVGAnimatedPreserveAspectRatio = static_cast<JSSVGAnimatedPreserveAspectRatio*>(handle.get().asCell());
