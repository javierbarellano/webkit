...
bool JSHTMLLabelElementConstructor::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSHTMLLabelElementConstructor, JSDOMWrapper>(exec, &JSHTMLLabelElementConstructorTable, static_cast<JSHTMLLabelElementConstructor*>(cell), propertyName, slot);
}

bool JSHTMLLabelElementConstructor::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
    return getStaticValueDescriptor<JSHTMLLabelElementConstructor, JSDOMWrapper>(exec, &JSHTMLLabelElementConstructorTable, static_cast<JSHTMLLabelElementConstructor*>(object), propertyName, descriptor);
}
...
bool JSHTMLLabelElement::getOwnPropertySlot(JSCell* cell, ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
...
bool JSHTMLLabelElement::getOwnPropertyDescriptor(JSObject* object, ExecState* exec, const Identifier& propertyName, PropertyDescriptor& descriptor)
{
...
void JSHTMLLabelElement::put(JSCell* cell, ExecState* exec, const Identifier& propertyName, JSValue value, PutPropertySlot& slot)
{
    JSHTMLLabelElement* thisObject = jsCast<JSHTMLLabelElement*>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);
